...
// actual size 0x1F0 in Oct 15 2021 Beta (see 0x94141B) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bBringToTopWhenClicked; \
/*0x0020*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0024*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0028*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x002C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0030*/ COLORREF DisabledBackground; \
/*0x0034*/ RECT		ClientRect; \
/*0x0044*/ DWORD  BackgroundDrawType; \
/*0x0048*/ void   *TitlePiece2; \
/*0x004C*/ bool		bUseInLayoutVertical; \
/*0x0050*/ void	    *pFont; \
/*0x0054*/ BYTE		StartAlpha; \
/*0x0058*/ void* pTipTextObject; \
/*0x005C*/ int		BlinkDuration; \
/*0x0060*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0064*/ RECT		TransitionRect; \
/*0x0074*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0078*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x007C*/ UINT		BlinkFadeDuration; \
/*0x0080*/ bool		bBottomAnchoredToTop; \
/*0x0081*/ bool		Fades; \
/*0x0084*/ int		DeleteCount; \
/*0x0088*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x008C*/ bool		bKeepOnScreen; \
/*0x0090*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0094*/ bool		bMaximizable; \
/*0x0098*/ RECT		IconRect; \
/*0x00A8*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00A9*/ bool		bAction; \
/*0x00AC*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00B0*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00B4*/ tagSIZE	MaxClientSize; \
/*0x00BC*/ int		VScrollMax; \
/*0x00C0*/ BYTE		TargetAlpha; \
/*0x00C1*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00C2*/ bool		Enabled; \
/*0x00C4*/ void *pController; \
/*0x00C8*/ bool		bClientRectChanged; \
/*0x00CC*/ int		TopOffset; \
/*0x00D0*/ UINT		BlinkFadeStartTime; \
/*0x00D4*/ bool		bScreenClipRectChanged; \
/*0x00D5*/ bool		bBorder2; \
/*0x00D6*/ bool		bUseInLayoutHorizontal; \
/*0x00D7*/ bool		bMaximized; \
/*0x00D8*/ BYTE		FadeAlpha; \
/*0x00D9*/ bool		bIsParentOrContextMenuWindow; \
/*0x00DA*/ bool		bActive; \
/*0x00DB*/ bool		bClipToParent; \
/*0x00E0*/ __int64		Data; \
/*0x00E8*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00EC*/ int		managerArrayIndex; \
/*0x00F0*/ BYTE		Alpha; \
/*0x00F1*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00F4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00F8*/ int		VScrollPos; \
/*0x00FC*/ tagSIZE	MinClientSize; \
/*0x0104*/ DWORD	LastTimeMouseOver; \
/*0x0108*/ bool		dShow; \
/*0x0109*/ bool		bFullyScreenClipped; \
/*0x010C*/ UINT		TransitionDuration; \
/*0x0110*/ LONG		BlinkStartTimer; \
/*0x0114*/ int		RightOffset; \
/*0x0118*/ int	Transition; \
/*0x011C*/ bool		bHCenterTooltip; \
/*0x011D*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0120*/ void	*IconTextureAnim; \
/*0x0124*/ int		BottomOffset; \
/*0x0128*/ bool		bTiled; \
/*0x0129*/ bool		Minimized; \
/*0x012C*/ RECT		ClipRectScreen; \
/*0x013C*/ int		HScrollPos; \
/*0x0140*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0144*/ int		HScrollMax; \
/*0x0148*/ RECT		ClipRectClient; \
/*0x0158*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x015C*/ UINT		FadeDuration; \
/*0x0160*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0164*/ void		*pLayoutStrategy; \
/*0x0168*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x016C*/ int		ParentAndContextMenuArrayIndex; \
/*0x0170*/ DWORD	FadeDelay; \
/*0x0174*/ void*	pTextObject; \
/*0x0178*/ bool		bIsTransitioning; \
/*0x017C*/ struct _CXSTR*	DataStr; \
/*0x0180*/ bool		bRightAnchoredToLeft; \
/*0x0184*/ int		BlinkState; \
/*0x0188*/ bool		Faded; \
/*0x0189*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x018C*/ int		LeftOffset; \
/*0x0190*/ bool		bMarkedForDelete; \
/*0x0191*/ BYTE     bResizableMask; \
/*0x0194*/ RECT		OldLocation; \
/*0x01A4*/ bool		bBorder; \
/*0x01A8*/ DWORD	XMLIndex; \
/*0x01AC*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01C4*/ UINT		TransitionStartTick; \
/*0x01C8*/ bool		bLeftAnchoredToLeft; \
/*0x01CC*/ void   *TitlePiece; \
/*0x01D0*/ void	*DrawTemplate; \
/*0x01D4*/ bool		bEscapableLocked; \
/*0x01D5*/ bool		bTopAnchoredToTop; \
/*0x01D8*/ UINT		BlinkFadeFreq; \
/*0x01DC*/ bool		bClientClipRectChanged; \
/*0x01DD*/ bool		bCaptureTitle; \
...
// CBazaarSearchWnd_size: 0x95f8 (see 56D5D2) in Oct 15 2021 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 56CF10) in Oct 15 2021 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 56CDB7) in Oct 15 2021 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 56CC6B) in Oct 15 2021 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 84C6BD) in Oct 15 2021 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 56CFFD) in Oct 15 2021 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 84C75B) in Oct 15 2021 Beta - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 7A27C0) in Oct 15 2021 Beta - eqmule
...
// CLootWnd_size: 0x3b0 (see 56D34A) in Oct 15 2021 Beta - eqmule
...
// CMapViewWnd_size: 0x660 (see 56CAE0) in Oct 15 2021 Beta - eqmule 
...
// CMerchantWnd_size: 0x448 (see 56D496) in Oct 15 2021 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 56C57B) in Oct 15 2021 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 56C848) in Oct 15 2021 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 56D534) in Oct 15 2021 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 56D670) in Oct 15 2021 Beta - eqmule
