...
/*0x0020*/ RECT		ClipRectScreen; \
/*0x0030*/ bool		bUseInLayoutVertical; \
/*0x0034*/ int		DeleteCount; \
/*0x0038*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x003C*/ RECT		IconRect; \
/*0x004C*/ BYTE		TargetAlpha; \
/*0x004D*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x004E*/ bool		bAction; \
/*0x0050*/ DWORD	LastTimeMouseOver; \
/*0x0054*/ int		BottomOffset; \
/*0x0058*/ void	*DrawTemplate; \
/*0x005C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x005D*/ bool		bActive; \
/*0x0060*/ RECT		ClientRect; \
/*0x0070*/ DWORD	FadeDelay; \
/*0x0074*/ void*	pTextObject; \
/*0x0078*/ bool		bKeepOnScreen; \
/*0x007C*/ RECT		ClipRectClient; \
/*0x008C*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x008D*/ BYTE		Alpha; \
...
/*0x0095*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0098*/ int		TopOffset; \
/*0x009C*/ int		BlinkDuration; \
/*0x00A0*/ void	    *pFont; \
/*0x00A4*/ bool		bCaptureTitle; \
/*0x00A8*/ RECT		OldLocation; \
/*0x00B8*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00BC*/ UINT		TransitionDuration; \
/*0x00C0*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00C1*/ bool		bClientClipRectChanged; \
/*0x00C2*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00C4*/ void   *TitlePiece2; \
/*0x00C8*/ bool		bScreenClipRectChanged; \
/*0x00CC*/ int		BlinkState; \
/*0x00D0*/ bool		bUseInLayoutHorizontal; \
/*0x00D1*/ bool		bIsParentOrContextMenuWindow; \
/*0x00D2*/ bool		dShow; \
/*0x00D3*/ BYTE     bResizableMask; \
/*0x00D4*/ BYTE		FadeAlpha; \
/*0x00D8*/ int		HScrollPos; \
/*0x00DC*/ bool		bFullyScreenClipped; \
/*0x00E0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00F8*/ tagSIZE	MaxClientSize; \
/*0x0100*/ int	Transition; \
/*0x0104*/ bool		bTopAnchoredToTop; \
/*0x0105*/ bool		bMaximizable; \
/*0x0108*/ UINT		BlinkFadeStartTime; \
/*0x010C*/ void *pController; \
/*0x0110*/ void		*pLayoutStrategy; \
/*0x0114*/ void   *TitlePiece; \
/*0x0118*/ bool		bIsTransitioning; \
/*0x0119*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x011A*/ bool		bEscapableLocked; \
/*0x011C*/ int		managerArrayIndex; \
/*0x0120*/ UINT		BlinkFadeDuration; \
/*0x0124*/ bool		bMarkedForDelete; \
/*0x0128*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x012C*/ UINT		BlinkFadeFreq; \
/*0x0130*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0134*/ DWORD  BackgroundDrawType; \
/*0x0138*/ RECT		Location; \
/*0x0148*/ tagSIZE	MinClientSize; \
/*0x0150*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0154*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0158*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x015C*/ void* pTipTextObject; \
/*0x0160*/ int		VScrollMax; \
/*0x0164*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0168*/ void	*IconTextureAnim; \
/*0x016C*/ COLORREF DisabledBackground; \
/*0x0170*/ UINT		TransitionStartTick; \
/*0x0174*/ bool		bBottomAnchoredToTop; \
/*0x0175*/ BYTE		StartAlpha; \
/*0x0176*/ bool		bTiled; \
/*0x0178*/ int		RightOffset; \
/*0x017C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0180*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0184*/ LONG		BlinkStartTimer; \
/*0x0188*/ bool		bClientRectChanged; \
/*0x018C*/ int		LeftOffset; \
/*0x0190*/ bool		Minimized; \
/*0x0191*/ bool		bRightAnchoredToLeft; \
/*0x0194*/ struct _CXSTR*	DataStr; \
/*0x0198*/ int		ParentAndContextMenuArrayIndex; \
/*0x019C*/ bool		Faded; \
/*0x019D*/ bool		bBringToTopWhenClicked; \
/*0x019E*/ bool		bLeftAnchoredToLeft; \
/*0x01A0*/ __int64		Data; \
/*0x01A8*/ bool		bBorder2; \
/*0x01AC*/ DWORD	XMLIndex; \
/*0x01B0*/ int		HScrollMax; \
/*0x01B4*/ bool		Fades; \
/*0x01B5*/ bool		Enabled; \
/*0x01B6*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01B7*/ bool		bMaximized; \
/*0x01B8*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01B9*/ bool		bClipToParent; \
/*0x01BC*/ RECT		TransitionRect; \
/*0x01CC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01D0*/ UINT		LastBlinkFadeRefreshTime; \
/*0x01D4*/ int		VScrollPos; \
/*0x01D8*/ bool		bBorder; \
/*0x01D9*/ BYTE Filler0x01D9[0x7]; \
/*0x01E0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95e8 (see 56D6B2) in Nov  2 2021 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2e0 (see 56CFF0) in Nov  2 2021 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 56CE97) in Nov  2 2021 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 56CD4B) in Nov  2 2021 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 84CEBD) in Nov  2 2021 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 56D0DD) in Nov  2 2021 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 84CF5B) in Nov  2 2021 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 7A2E70) in Nov  2 2021 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 56D42A) in Nov  2 2021 Beta - eqmule
...
// CMapViewWnd_size: 0x640 (see 56CBC0) in Nov  2 2021 Beta - eqmule
...
// CMerchantWnd_size: 0x438 (see 56D576) in Nov  2 2021 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 56C65B) in Nov  2 2021 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 56C928) in Nov  2 2021 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 56D614) in Nov  2 2021 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 56D750) in Nov  2 2021 Beta - eqmule
