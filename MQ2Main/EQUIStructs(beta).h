...
// actual size 0x1E8 in Oct 26 2021 Beta (see 0x940BFB) - eqmule
// actual size 0x1E0 in Oct 27 2021 Beta (see 0x9407FB) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ RECT		IconRect; \
/*0x002C*/ BYTE		TargetAlpha; \
/*0x0030*/ struct _CXSTR*	DataStr; \
/*0x0034*/ RECT		Location; \
/*0x0044*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x005C*/ bool		bMaximizable; \
/*0x0060*/ DWORD	XMLIndex; \
/*0x0064*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0065*/ bool		bClientClipRectChanged; \
/*0x0068*/ int		RightOffset; \
/*0x006C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x006D*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0070*/ RECT		OldLocation; \
/*0x0080*/ void	    *pFont; \
/*0x0084*/ bool		Minimized; \
/*0x0088*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x008C*/ DWORD  BackgroundDrawType; \
/*0x0090*/ DWORD	LastTimeMouseOver; \
/*0x0094*/ bool		bHCenterTooltip; \
/*0x0095*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0096*/ bool		bMarkedForDelete; \
/*0x0098*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x009C*/ bool		bEscapableLocked; \
/*0x009D*/ BYTE     bResizableMask; \
/*0x009E*/ bool		bBorder2; \
/*0x00A0*/ void   *TitlePiece; \
/*0x00A4*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00A8*/ int		DeleteCount; \
/*0x00AC*/ bool		bBringToTopWhenClicked; \
/*0x00B0*/ DWORD	FadeDelay; \
/*0x00B4*/ bool		bMaximized; \
/*0x00B8*/ int		BottomOffset; \
/*0x00BC*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00BD*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00BE*/ bool		bFullyScreenClipped; \
/*0x00BF*/ bool		Faded; \
/*0x00C0*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00C1*/ bool		bLeftAnchoredToLeft; \
/*0x00C4*/ int		managerArrayIndex; \
/*0x00C8*/ bool		bClientRectChanged; \
/*0x00C9*/ bool		Fades; \
/*0x00CC*/ UINT		TransitionStartTick; \
/*0x00D0*/ bool		bClipToParent; \
/*0x00D1*/ BYTE		Alpha; \
/*0x00D4*/ int		ParentAndContextMenuArrayIndex; \
/*0x00D8*/ RECT		ClipRectClient; \
/*0x00E8*/ RECT		TransitionRect; \
/*0x00F8*/ bool		bAction; \
/*0x00F9*/ bool		bTiled; \
/*0x00FC*/ int		LeftOffset; \
/*0x0100*/ bool		bIsTransitioning; \
/*0x0104*/ tagSIZE	MinClientSize; \
/*0x010C*/ bool		bScreenClipRectChanged; \
/*0x010D*/ bool		Enabled; \
/*0x010E*/ BYTE		FadeAlpha; \
/*0x0110*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0114*/ UINT		FadeDuration; \
/*0x0118*/ UINT		LastBlinkFadeRefreshTime; \
/*0x011C*/ bool		bUseInLayoutVertical; \
/*0x0120*/ int		VScrollPos; \
/*0x0124*/ UINT		BlinkFadeFreq; \
/*0x0128*/ int		TopOffset; \
/*0x012C*/ int	Transition; \
/*0x0130*/ void	*IconTextureAnim; \
/*0x0134*/ void		*pLayoutStrategy; \
/*0x0138*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0139*/ bool		bCaptureTitle; \
/*0x013C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0140*/ int		BlinkState; \
/*0x0144*/ COLORREF DisabledBackground; \
/*0x0148*/ bool		bUseInLayoutHorizontal; \
...
/*0x0150*/ tagSIZE	MaxClientSize; \
/*0x0158*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x015C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0160*/ UINT		BlinkFadeStartTime; \
/*0x0164*/ void*	pTextObject; \
/*0x0168*/ bool		bIsParentOrContextMenuWindow; \
/*0x016C*/ int		HScrollPos; \
/*0x0170*/ RECT		ClipRectScreen; \
/*0x0180*/ void   *TitlePiece2; \
/*0x0184*/ UINT		BlinkFadeDuration; \
/*0x0188*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x018C*/ int		HScrollMax; \
/*0x0190*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0191*/ bool		bRightAnchoredToLeft; \
/*0x0194*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0198*/ int		VScrollMax; \
/*0x019C*/ bool		dShow; \
/*0x019D*/ bool		bBottomAnchoredToTop; \
/*0x01A0*/ RECT		ClientRect; \
/*0x01B0*/ LONG		BlinkStartTimer; \
/*0x01B4*/ void	*DrawTemplate; \
/*0x01B8*/ BYTE		StartAlpha; \
/*0x01B9*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01BA*/ bool		bActive; \
/*0x01BC*/ int		BlinkDuration; \
/*0x01C0*/ void *pController; \
/*0x01C4*/ void* pTipTextObject; \
/*0x01C8*/ __int64		Data; \
/*0x01D0*/ bool		bKeepOnScreen; \
/*0x01D4*/ UINT		TransitionDuration; \
/*0x01D8*/ bool		bTopAnchoredToTop; \
/*0x01D9*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01DA*/ bool		bBorder; \
/*0x01DB*/ BYTE Filler0x01DB[0x5]; \
/*0x01E0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95e8 (see 56D4F2) in Oct 27 2021 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2e0 (see 56CE30) in Oct 27 2021 Beta - eqmule
...
// CTargetWindow_size: 0x8c0 (see 56CCD7) in Oct 27 2021 Beta - eqmule
...
// CBuffWindow_size: 0x710 (see 56CB8B) in Oct 27 2021 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 84BED3) in Oct 27 2021 Beta - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 56CF1D) in Oct 27 2021 Beta - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 84BF71) in Oct 27 2021 Beta - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 7A2090) in Oct 27 2021 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 56D26A) in Oct 27 2021 Beta - eqmule
...
// CMapViewWnd_size: 0x640 (see 56CA00) in Oct 27 2021 Beta - eqmule
...
// CMerchantWnd_size: 0x438 (see 56D3B6) in Oct 27 2021 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 56C49B) in Oct 27 2021 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 56C768) in Oct 27 2021 Beta - eqmule
...
// CTradeWnd__size: 0x2e8 (see 56D454) in Oct 27 2021 Beta - eqmule
...
// CFactionWnd__size: 0x270 (see 56D590) in Oct 27 2021 Beta - eqmule
