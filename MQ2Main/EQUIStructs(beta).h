...
// actual size 0x1E8 in Oct 13 2021 Beta (see 0x94120B) - eqmule
...
/*0x0028*/ UINT		TransitionStartTick; \
/*0x002C*/ bool		bUseInLayoutHorizontal; \
/*0x0030*/ RECT		ClipRectClient; \
/*0x0040*/ bool		bBottomAnchoredToTop; \
/*0x0044*/ UINT		FadeDuration; \
/*0x0048*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x004C*/ struct _CXSTR*	DataStr; \
/*0x0050*/ int		VScrollMax; \
/*0x0054*/ bool		bTopAnchoredToTop; \
/*0x0058*/ int	Transition; \
/*0x005C*/ tagSIZE	MinClientSize; \
/*0x0064*/ bool		bClientClipRectChanged; \
/*0x0068*/ LONG		BlinkStartTimer; \
/*0x006C*/ bool		bHCenterTooltip; \
/*0x006D*/ bool		bBringToTopWhenClicked; \
/*0x006E*/ bool		bFullyScreenClipped; \
/*0x0070*/ RECT		TransitionRect; \
/*0x0080*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0098*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x009C*/ void	    *pFont; \
/*0x00A0*/ void   *TitlePiece; \
/*0x00A4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00A8*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00AC*/ void	*DrawTemplate; \
/*0x00B0*/ BYTE		FadeAlpha; \
/*0x00B1*/ bool		Enabled; \
/*0x00B4*/ tagSIZE	MaxClientSize; \
/*0x00BC*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00C0*/ RECT		IconRect; \
/*0x00D0*/ RECT		ClipRectScreen; \
/*0x00E0*/ bool		bBorder2; \
/*0x00E4*/ UINT		BlinkFadeDuration; \
/*0x00E8*/ bool		bClientRectChanged; \
/*0x00EC*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00F0*/ bool		bScreenClipRectChanged; \
/*0x00F1*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00F2*/ bool		bKeepOnScreen; \
/*0x00F4*/ int		BottomOffset; \
/*0x00F8*/ bool		bIsParentOrContextMenuWindow; \
/*0x00F9*/ bool		bCaptureTitle; \
/*0x00FA*/ bool		bActive; \
/*0x00FC*/ int		HScrollPos; \
/*0x0100*/ DWORD	FadeDelay; \
/*0x0104*/ bool		bMaximizable; \
/*0x0105*/ bool		bClipToParent; \
/*0x0106*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0107*/ BYTE		StartAlpha; \
/*0x0108*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x010C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0110*/ bool		Faded; \
/*0x0114*/ RECT		ClientRect; \
/*0x0124*/ int		HScrollMax; \
/*0x0128*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0129*/ bool		bEscapableLocked; \
/*0x012C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0130*/ COLORREF DisabledBackground; \
/*0x0134*/ void	*IconTextureAnim; \
/*0x0138*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0139*/ bool		Fades; \
/*0x013C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0140*/ void* pTipTextObject; \
/*0x0144*/ void *pController; \
/*0x0148*/ bool		bUseInLayoutVertical; \
/*0x014C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0150*/ int		ParentAndContextMenuArrayIndex; \
/*0x0154*/ DWORD	LastTimeMouseOver; \
/*0x0158*/ void		*pLayoutStrategy; \
/*0x015C*/ void*	pTextObject; \
/*0x0160*/ int		DeleteCount; \
/*0x0164*/ int		LeftOffset; \
/*0x0168*/ RECT		Location; \
/*0x0178*/ int		TopOffset; \
/*0x017C*/ BYTE     bResizableMask; \
/*0x017D*/ bool		bLeftAnchoredToLeft; \
/*0x0180*/ int		VScrollPos; \
/*0x0184*/ bool		bTiled; \
/*0x0188*/ UINT		LastBlinkFadeRefreshTime; \
/*0x018C*/ bool		bAction; \
/*0x018D*/ bool		bMaximized; \
/*0x0190*/ DWORD  BackgroundDrawType; \
/*0x0194*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0198*/ BYTE		TargetAlpha; \
/*0x019C*/ RECT		OldLocation; \
/*0x01AC*/ bool		bMarkedForDelete; \
/*0x01AD*/ bool		bIsTransitioning; \
/*0x01AE*/ bool		dShow; \
/*0x01B0*/ int		BlinkDuration; \
/*0x01B4*/ int		RightOffset; \
/*0x01B8*/ bool		bRightAnchoredToLeft; \
/*0x01B9*/ BYTE		Alpha; \
/*0x01BA*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x01BC*/ DWORD	XMLIndex; \
/*0x01C0*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x01C4*/ void   *TitlePiece2; \
/*0x01C8*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01CC*/ UINT		BlinkFadeStartTime; \
/*0x01D0*/ __int64		Data; \
/*0x01D8*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01DC*/ int		managerArrayIndex; \
/*0x01E0*/ bool		Minimized; \
/*0x01E1*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x01E4*/ UINT		TransitionDuration; \
/*0x01E8*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95f0 (see 56D562) in Oct 13 2021 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2e8 (see 56CEA0) in Oct 13 2021 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 56CD47) in Oct 13 2021 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 56CBFB) in Oct 13 2021 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 84C3DD) in Oct 13 2021 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 56CF8D) in Oct 13 2021 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 84C47B) in Oct 13 2021 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7A2590) in Oct 13 2021 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 56D2DA) in Oct 13 2021 Beta - eqmule
...
// CMapViewWnd_size: 0x650 (see 56CA70) in Oct 13 2021 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 56D426) in Oct 13 2021 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 56C50B) in Oct 13 2021 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 56C7D8) in Oct 13 2021 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 56D4C4) in Oct 13 2021 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 56D600) in Oct 13 2021 Beta - eqmule
