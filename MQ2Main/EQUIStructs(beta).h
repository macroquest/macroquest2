...
/*0x001D*/ bool		bClipToParent; \
/*0x0020*/ RECT		OldLocation; \
/*0x0030*/ void*	pTextObject; \
/*0x0034*/ bool		Enabled; \
/*0x0038*/ UINT		BlinkFadeDuration; \
/*0x003C*/ COLORREF DisabledBackground; \
/*0x0040*/ tagSIZE	MaxClientSize; \
/*0x0048*/ void* pTipTextObject; \
/*0x004C*/ bool		bUseInLayoutHorizontal; \
/*0x0050*/ void	*IconTextureAnim; \
/*0x0058*/ __int64		Data; \
/*0x0060*/ bool		bCaptureTitle; \
/*0x0061*/ bool		bLeftAnchoredToLeft; \
/*0x0064*/ int		managerArrayIndex; \
/*0x0068*/ int		ParentAndContextMenuArrayIndex; \
/*0x006C*/ RECT		Location; \
/*0x007C*/ RECT		IconRect; \
/*0x008C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0090*/ UINT		TransitionDuration; \
/*0x0094*/ BYTE		StartAlpha; \
/*0x0095*/ bool		bUseInLayoutVertical; \
/*0x0098*/ void   *TitlePiece2; \
/*0x009C*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00A0*/ int		HScrollPos; \
/*0x00A4*/ bool		bEscapableLocked; \
/*0x00A5*/ BYTE		FadeAlpha; \
/*0x00A6*/ BYTE     bResizableMask; \
/*0x00A8*/ int		VScrollMax; \
/*0x00AC*/ bool		bTiled; \
/*0x00AD*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00B0*/ LONG		BlinkStartTimer; \
/*0x00B4*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00B8*/ bool		bMaximized; \
/*0x00B9*/ bool		bScreenClipRectChanged; \
/*0x00BC*/ void	    *pFont; \
/*0x00C0*/ bool		bClientRectChanged; \
/*0x00C1*/ BYTE		TargetAlpha; \
/*0x00C4*/ int		LeftOffset; \
/*0x00C8*/ RECT		ClientRect; \
/*0x00D8*/ int		BottomOffset; \
/*0x00DC*/ bool		bMarkedForDelete; \
/*0x00E0*/ int		VScrollPos; \
/*0x00E4*/ bool		bFullyScreenClipped; \
/*0x00E5*/ bool		bAction; \
/*0x00E8*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00EC*/ bool		bBorder2; \
...
/*0x00EE*/ bool		bRightAnchoredToLeft; \
/*0x00F0*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00F4*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00F8*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00FC*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0100*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0118*/ UINT		FadeDuration; \
/*0x011C*/ UINT		BlinkFadeStartTime; \
/*0x0120*/ bool		dShow; \
/*0x0124*/ int		BlinkDuration; \
/*0x0128*/ void *pController; \
...
/*0x0134*/ DWORD	XMLIndex; \
/*0x0138*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x013C*/ UINT		BlinkFadeFreq; \
/*0x0140*/ int		RightOffset; \
/*0x0144*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0145*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0148*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x014C*/ RECT		ClipRectClient; \
/*0x015C*/ bool		bClientClipRectChanged; \
/*0x015D*/ bool		bIsTransitioning; \
...
/*0x0164*/ BYTE		Alpha; \
/*0x0168*/ int		HScrollMax; \
/*0x016C*/ bool		Minimized; \
/*0x016D*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x016E*/ bool		bMaximizable; \
/*0x0170*/ void	*DrawTemplate; \
/*0x0174*/ UINT		TransitionStartTick; \
/*0x0178*/ bool		bActive; \
/*0x017C*/ void		*pLayoutStrategy; \
/*0x0180*/ bool		bBringToTopWhenClicked; \
/*0x0181*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0184*/ DWORD	FadeDelay; \
/*0x0188*/ DWORD  BackgroundDrawType; \
/*0x018C*/ bool		bHCenterTooltip; \
/*0x0190*/ tagSIZE	MinClientSize; \
/*0x0198*/ int	Transition; \
/*0x019C*/ bool		bBottomAnchoredToTop; \
/*0x01A0*/ DWORD	LastTimeMouseOver; \
/*0x01A4*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01A8*/ int		DeleteCount; \
/*0x01AC*/ RECT		ClipRectScreen; \
/*0x01BC*/ bool		bKeepOnScreen; \
/*0x01C0*/ void   *TitlePiece; \
/*0x01C4*/ RECT		TransitionRect; \
/*0x01D4*/ struct _CXSTR*	DataStr; \
/*0x01D8*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x01DC*/ bool		bTopAnchoredToTop; \
/*0x01E0*/ int		TopOffset; \
/*0x01E4*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01E8*/ int		BlinkState; \
