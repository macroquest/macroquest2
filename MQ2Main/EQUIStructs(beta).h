...
// actual size 0x1E0 in Oct 27 2021 Beta (see 0x9407FB) - eqmule
// actual size 0x1E8 in Nov  1 2021 Beta (see 0x94169B) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0020*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0021*/ BYTE		StartAlpha; \
/*0x0022*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0023*/ bool		bTopAnchoredToTop; \
/*0x0024*/ RECT		TransitionRect; \
/*0x0034*/ UINT		BlinkFadeDuration; \
/*0x0038*/ bool		bMaximized; \
/*0x003C*/ RECT		ClientRect; \
/*0x004C*/ void*	pTextObject; \
/*0x0050*/ RECT		Location; \
/*0x0060*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0064*/ int		VScrollPos; \
/*0x0068*/ int		BottomOffset; \
/*0x006C*/ bool		bBringToTopWhenClicked; \
/*0x006D*/ bool		bAction; \
/*0x006E*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0070*/ void *pController; \
/*0x0074*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0078*/ RECT		OldLocation; \
/*0x0088*/ bool		bMarkedForDelete; \
/*0x008C*/ void   *TitlePiece; \
/*0x0090*/ __int64		Data; \
/*0x0098*/ bool		Faded; \
/*0x0099*/ bool		bKeepOnScreen; \
/*0x009C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x00A0*/ bool		bClientRectChanged; \
/*0x00A4*/ tagSIZE	MinClientSize; \
/*0x00AC*/ int		HScrollMax; \
/*0x00B0*/ DWORD	XMLIndex; \
/*0x00B4*/ bool		bMaximizable; \
/*0x00B5*/ bool		bCaptureTitle; \
/*0x00B6*/ bool		bScreenClipRectChanged; \
/*0x00B7*/ bool		bIsParentOrContextMenuWindow; \
/*0x00B8*/ bool		dShow; \
/*0x00BC*/ UINT		BlinkFadeFreq; \
/*0x00C0*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00C4*/ UINT		FadeDuration; \
/*0x00C8*/ BYTE		FadeAlpha; \
/*0x00CC*/ DWORD  BackgroundDrawType; \
/*0x00D0*/ bool		bClientClipRectChanged; \
/*0x00D4*/ UINT		TransitionDuration; \
/*0x00D8*/ bool		bActive; \
/*0x00D9*/ bool		bUseInLayoutVertical; \
/*0x00DC*/ COLORREF DisabledBackground; \
/*0x00E0*/ bool		bFullyScreenClipped; \
/*0x00E1*/ bool		bBorder2; \
/*0x00E4*/ int		TopOffset; \
/*0x00E8*/ int	Transition; \
/*0x00EC*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x00F0*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00F4*/ void		*pLayoutStrategy; \
/*0x00F8*/ bool		bBorder; \
/*0x00FC*/ LONG		BlinkStartTimer; \
/*0x0100*/ int		RightOffset; \
/*0x0104*/ bool		bLeftAnchoredToLeft; \
/*0x0108*/ UINT		BlinkFadeStartTime; \
/*0x010C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0110*/ BYTE     bResizableMask; \
/*0x0114*/ RECT		ClipRectScreen; \
/*0x0124*/ int		ParentAndContextMenuArrayIndex; \
/*0x0128*/ void	*IconTextureAnim; \
/*0x012C*/ int		BlinkState; \
/*0x0130*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0134*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0138*/ RECT		ClipRectClient; \
/*0x0148*/ bool		bHCenterTooltip; \
/*0x0149*/ bool		Minimized; \
/*0x014C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0150*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0154*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x016C*/ bool		Enabled; \
/*0x016D*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x016E*/ bool		bIsTransitioning; \
/*0x0170*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0174*/ struct _CXSTR*	DataStr; \
/*0x0178*/ int		VScrollMax; \
/*0x017C*/ void* pTipTextObject; \
/*0x0180*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0184*/ bool		bRightAnchoredToLeft; \
/*0x0185*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0186*/ BYTE		TargetAlpha; \
/*0x0188*/ int		BlinkDuration; \
/*0x018C*/ tagSIZE	MaxClientSize; \
/*0x0194*/ bool		Fades; \
/*0x0198*/ DWORD	FadeDelay; \
/*0x019C*/ BYTE		Alpha; \
/*0x019D*/ bool		bEscapableLocked; \
/*0x019E*/ bool		bUseInLayoutHorizontal; \
/*0x01A0*/ int		HScrollPos; \
/*0x01A4*/ bool		bTiled; \
/*0x01A5*/ bool		bClipToParent; \
/*0x01A8*/ int		LeftOffset; \
/*0x01AC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x01B0*/ void   *TitlePiece2; \
/*0x01B4*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01B8*/ DWORD	LastTimeMouseOver; \
/*0x01BC*/ int		DeleteCount; \
/*0x01C0*/ void	    *pFont; \
/*0x01C4*/ bool		bBottomAnchoredToTop; \
/*0x01C8*/ int		managerArrayIndex; \
/*0x01CC*/ UINT		TransitionStartTick; \
/*0x01D0*/ RECT		IconRect; \
/*0x01E0*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01E4*/ void	*DrawTemplate; \
/*0x01E8*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95f0 (see 56D542) in Nov  1 2021 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2e8 (see 56CE80) in Nov  1 2021 Beta - eqmule
...
// CTargetWindow_size: 0x8c8 (see 56CD27) in Nov  1 2021 Beta - eqmule
...
// CBuffWindow_size: 0x718 (see 56CBDB) in Nov  1 2021 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 84C32D) in Nov  1 2021 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 56CF6D) in Nov  1 2021 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 84C3CB) in Nov  1 2021 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7A24C0) in Nov  1 2021 Beta - eqmule
...
// CLootWnd_size: 0x3a8 (see 56D2BA) in Nov  1 2021 Beta - eqmule
...
// CMapViewWnd_size: 0x650 (see 56CA50) in Nov  1 2021 Beta - eqmule
...
// CMerchantWnd_size: 0x440 (see 56D406) in Nov  1 2021 Beta - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 56C4EB) in Nov  1 2021 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 56C7B8) in Nov  1 2021 Beta - eqmule
...
// CTradeWnd__size: 0x2f0 (see 56D4A4) in Nov  1 2021 Beta - eqmule
...
// CFactionWnd__size: 0x278 (see 56D5E0) in Nov  1 2021 Beta - eqmule
