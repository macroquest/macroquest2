...
// actual size 0x1E0 in Nov  5 2020 Beta (see 0x93E0FD) - eqmule
// actual size 0x1F8 in Nov 10 2020 Beta (see 0x93FAAD) - eqmule
// actual size 0x1E8 in Dec  1 2020 Beta (see 0x93FCBD) - eqmule
// actual size 0x1E0 in Dec  5 2020 Beta (see 0x94117D) - eqmule
// actual size 0x1F0 in Dec  7 2020 Beta (see 0x940E0D) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ void* pTipTextObject; \
/*0x0020*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0024*/ DWORD	FadeDelay; \
/*0x0028*/ UINT		LastBlinkFadeRefreshTime; \
...
/*0x0030*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0034*/ bool		bCaptureTitle; \
/*0x0038*/ RECT		ClipRectScreen; \
/*0x0048*/ LONG		BlinkStartTimer; \
/*0x004C*/ RECT		OldLocation; \
/*0x005C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0060*/ bool		bFullyScreenClipped; \
/*0x0061*/ bool		bTopAnchoredToTop; \
/*0x0064*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0068*/ bool		bAction; \
/*0x006C*/ RECT		ClipRectClient; \
/*0x007C*/ bool		bMarkedForDelete; \
/*0x0080*/ int		HScrollMax; \
/*0x0084*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0085*/ bool		bClipToParent; \
/*0x0086*/ bool		Fades; \
/*0x0088*/ int		TopOffset; \
/*0x008C*/ bool		bHCenterTooltip; \
/*0x0090*/ UINT		BlinkFadeFreq; \
/*0x0094*/ int		BlinkState; \
/*0x0098*/ UINT		BlinkFadeDuration; \
/*0x009C*/ int		LeftOffset; \
/*0x00A0*/ tagSIZE	MaxClientSize; \
/*0x00A8*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x00AC*/ bool		bIsParentOrContextMenuWindow; \
/*0x00AD*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x00AE*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00AF*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00B0*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00B4*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00CC*/ int		DeleteCount; \
/*0x00D0*/ void	    *pFont; \
/*0x00D4*/ bool		bBringToTopWhenClicked; \
/*0x00D8*/ int		VScrollMax; \
/*0x00DC*/ void		*pLayoutStrategy; \
/*0x00E0*/ DWORD  BackgroundDrawType; \
/*0x00E4*/ bool		bTiled; \
...
/*0x00F4*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00F5*/ BYTE		Alpha; \
/*0x00F8*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x00FC*/ void*	pTextObject; \
/*0x0100*/ bool		bBottomAnchoredToTop; \
/*0x0104*/ void	*DrawTemplate; \
/*0x0108*/ UINT		BlinkFadeStartTime; \
/*0x010C*/ bool		bIsTransitioning; \
/*0x0110*/ RECT		TransitionRect; \
/*0x0120*/ bool		dShow; \
/*0x0124*/ void   *TitlePiece2; \
/*0x0128*/ bool		bMaximizable; \
/*0x0129*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x012C*/ int		HScrollPos; \
/*0x0130*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0134*/ void	*IconTextureAnim; \
/*0x0138*/ COLORREF DisabledBackground; \
/*0x013C*/ bool		Minimized; \
/*0x013D*/ bool		bUseInLayoutVertical; \
/*0x0140*/ RECT		IconRect; \
/*0x0150*/ DWORD	XMLIndex; \
/*0x0154*/ bool		bUseInLayoutHorizontal; \
/*0x0158*/ RECT		Location; \
/*0x0168*/ UINT		TransitionStartTick; \
/*0x016C*/ bool		bBorder; \
/*0x016D*/ BYTE		TargetAlpha; \
/*0x0170*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0174*/ DWORD	LastTimeMouseOver; \
/*0x0178*/ bool		bRightAnchoredToLeft; \
/*0x0179*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x017A*/ bool		bClientClipRectChanged; \
/*0x017C*/ int		BottomOffset; \
/*0x0180*/ void *pController; \
/*0x0184*/ bool		bLeftAnchoredToLeft; \
/*0x0185*/ bool		bEscapableLocked; \
/*0x0188*/ struct _CXSTR*	DataStr; \
/*0x018C*/ UINT		TransitionDuration; \
/*0x0190*/ UINT		FadeDuration; \
/*0x0194*/ int		BlinkDuration; \
/*0x0198*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01A0*/ __int64		Data; \
/*0x01A8*/ bool		bClientRectChanged; \
/*0x01AC*/ void   *TitlePiece; \
/*0x01B0*/ bool		bScreenClipRectChanged; \
/*0x01B1*/ BYTE     bResizableMask; \
/*0x01B4*/ int		RightOffset; \
/*0x01B8*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01BC*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01C0*/ BYTE		FadeAlpha; \
/*0x01C4*/ int		VScrollPos; \
/*0x01C8*/ int		managerArrayIndex; \
/*0x01CC*/ bool		Faded; \
/*0x01CD*/ BYTE		StartAlpha; \
/*0x01CE*/ bool		bKeepOnScreen; \
/*0x01CF*/ bool		bActive; \
/*0x01D0*/ tagSIZE	MinClientSize; \
/*0x01D8*/ int	Transition; \
/*0x01DC*/ RECT		ClientRect; \
/*0x01EC*/ bool		bMaximized; \
/*0x01ED*/ bool		Enabled; \
/*0x01EE*/ BYTE Filler0x01EE[0x2]; \
/*0x01F0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x92d8 (see 55B8CE) in Dec  7 2020 Beta - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 55B1BE) in Dec  7 2020 Beta - eqmule
...
// CTargetWindow_size: 0x8d0 (see 55B055) in Dec  7 2020 Beta - eqmule
...
// CBuffWindow_size: 0x720 (see 55AEF9) in Dec  7 2020 Beta - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 7FDD3B) in Dec  7 2020 Beta - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 55B2B7) in Dec  7 2020 Beta - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 7FDE4C) in Dec  7 2020 Beta - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 760A62) in Dec  7 2020 Beta - eqmule
...
// CLootWnd_size: 0x3a0 (see 55B626) in Dec  7 2020 Beta - eqmule
...
// CMapViewWnd_size: 0x658 (see 55AD5A) in Dec  7 2020 Beta - eqmule
...
// CMerchantWnd_size: 0x450 (see 55B782) in Dec  7 2020 Beta - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 55A7B1) in Dec  7 2020 Beta - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 55AAA2) in Dec  7 2020 Beta - eqmule
...
// CTradeWnd__size: 0x2f8 (see 55B828) in Dec  7 2020 Beta - eqmule
...
// CFactionWnd__size: 0x280 (see 55B974) in Dec  7 2020 Beta - eqmule
