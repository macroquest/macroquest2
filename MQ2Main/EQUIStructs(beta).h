...
// actual size 0x1F8 in Oct 20 2021 Beta (see 0x9415BB) - eqmule
// actual size 0x1F0 in Oct 24 2021 Beta (see 0x940B6B) - eqmule
// actual size 0x1E8 in Nov  1 2021 Beta (see 0x94169B) - eqmule
// actual size 0x1E0 in Nov  2 2021 Beta (see 0x941F7B) - eqmule
// actual size 0x1E8 in Nov  5 2021 Beta (see 0x9411FB) - SwiftyMUSE
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ int		BottomOffset; \
/*0x0020*/ int		TopOffset; \
/*0x0024*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0028*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x002C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0030*/ RECT		ClipRectScreen; \
/*0x0040*/ void	*IconTextureAnim; \
/*0x0048*/ __int64		Data; \
/*0x0050*/ int		RightOffset; \
/*0x0054*/ RECT		OldLocation; \
/*0x0064*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0068*/ void *pController; \
/*0x006C*/ int		HScrollMax; \
/*0x0070*/ int		BlinkState; \
/*0x0074*/ int		DeleteCount; \
/*0x0078*/ int		ParentAndContextMenuArrayIndex; \
/*0x007C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0080*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0084*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0088*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x008C*/ void		*pLayoutStrategy; \
/*0x0090*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0094*/ UINT		BlinkFadeDuration; \
/*0x0098*/ bool		bMaximizable; \
/*0x009C*/ UINT		FadeDuration; \
/*0x00A0*/ DWORD	XMLIndex; \
/*0x00A4*/ BYTE		FadeAlpha; \
/*0x00A8*/ int		managerArrayIndex; \
/*0x00AC*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x00B0*/ bool		bUseInLayoutVertical; \
/*0x00B4*/ int		HScrollPos; \
/*0x00B8*/ bool		bFullyScreenClipped; \
/*0x00B9*/ bool		bEscapableLocked; \
/*0x00BC*/ LONG		BlinkStartTimer; \
/*0x00C0*/ BYTE		Alpha; \
/*0x00C1*/ bool		bActive; \
/*0x00C2*/ bool		bTopAnchoredToTop; \
/*0x00C4*/ COLORREF DisabledBackground; \
/*0x00C8*/ void*	pTextObject; \
/*0x00CC*/ RECT		Location; \
/*0x00DC*/ bool		bHCenterTooltip; \
/*0x00DD*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00DE*/ bool		bUseInLayoutHorizontal; \
/*0x00DF*/ bool		bRightAnchoredToLeft; \
/*0x00E0*/ int		LeftOffset; \
/*0x00E4*/ BYTE     bResizableMask; \
/*0x00E8*/ RECT		ClipRectClient; \
/*0x00F8*/ bool		bClientClipRectChanged; \
/*0x00F9*/ bool		bKeepOnScreen; \
/*0x00FA*/ bool		Faded; \
/*0x00FB*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x00FC*/ bool		bClientRectChanged; \
/*0x00FD*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0100*/ void   *TitlePiece; \
/*0x0104*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x011C*/ int		VScrollMax; \
/*0x0120*/ bool		bMaximized; \
/*0x0124*/ void* pTipTextObject; \
/*0x0128*/ tagSIZE	MaxClientSize; \
/*0x0130*/ bool		bBringToTopWhenClicked; \
/*0x0134*/ int		BlinkDuration; \
/*0x0138*/ DWORD	LastTimeMouseOver; \
/*0x013C*/ bool		bLeftAnchoredToLeft; \
/*0x013D*/ bool		bCaptureTitle; \
/*0x0140*/ void	    *pFont; \
/*0x0144*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0148*/ RECT		ClientRect; \
/*0x0158*/ bool		bTiled; \
/*0x015C*/ tagSIZE	MinClientSize; \
/*0x0164*/ bool		Fades; \
/*0x0165*/ bool		bIsTransitioning; \
/*0x0166*/ bool		bMarkedForDelete; \
/*0x0168*/ RECT		IconRect; \
/*0x0178*/ UINT		TransitionDuration; \
/*0x017C*/ struct _CXSTR*	DataStr; \
/*0x0180*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0184*/ bool		Enabled; \
/*0x0185*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0186*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0188*/ UINT		BlinkFadeStartTime; \
/*0x018C*/ BYTE		StartAlpha; \
/*0x0190*/ DWORD  BackgroundDrawType; \
/*0x0194*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0198*/ UINT		LastBlinkFadeRefreshTime; \
/*0x019C*/ bool		bBorder2; \
/*0x019D*/ bool		bClipToParent; \
/*0x01A0*/ int	Transition; \
/*0x01A4*/ bool		bScreenClipRectChanged; \
/*0x01A8*/ UINT		BlinkFadeFreq; \
/*0x01AC*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01B0*/ DWORD	FadeDelay; \
/*0x01B4*/ bool		Minimized; \
/*0x01B8*/ void   *TitlePiece2; \
/*0x01BC*/ void	*DrawTemplate; \
/*0x01C0*/ UINT		TransitionStartTick; \
/*0x01C4*/ bool		bBorder; \
/*0x01C8*/ int		VScrollPos; \
/*0x01CC*/ RECT		TransitionRect; \
/*0x01DC*/ bool		dShow; \
/*0x01DD*/ bool		bIsParentOrContextMenuWindow; \
/*0x01DE*/ bool		bAction; \
/*0x01DF*/ bool		bBottomAnchoredToTop; \
/*0x01E0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01E4*/ BYTE		TargetAlpha; \
/*0x01E5*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01E6*/ BYTE Filler0x01E6[0x2]; \
/*0x01E8*/ \
public: \
			bool IsVisible() \
			{ \
...
#define SafeXLoc 0
	...
	// CBazaarSearchWnd_size: 0x95f0 (see 56D612) in Nov  3 2021 Beta - eqmule
	typedef struct _BAZAARSEARCHWND {
		/*0x0000*/ struct _CSIDLWND     Wnd;
		/*0x0230*/ BYTE         Unknown0x0230[0x9318];
		/*0x9548*/ void			**ppTraderData;
		/*0x954C*/ DWORD        hashVal;//find in CBazaarSearchWnd__HandleSearchResults_x
		/*0x9550*/ BYTE         Unknown0x9550[0xa0];
		/*0x95F0*/
	} BAZAARSEARCHWND, *PBAZAARSEARCHWND;

	//CPlayerWindow__CPlayerWindow aPlayerwindow
	//aAPwcsincombat
	// CPlayerWindow_size: 0x2e8 (see 56CF50) in Nov  3 2021 Beta - eqmule
	typedef struct _CPLAYERWND {
		/*0x0000*/ struct _CSIDLWND     Wnd;
		/*0x0230*/ BYTE         Unknown0x0230[0xb0];
		/*0x02e0*/ DWORD        CombatState;   // 1=debuffed, 2=combat cooldown, 3=stand, 4=sit
		/*0x02e4*/ DWORD		Unknown0x02e4;// added aug 11 2020 Test - eqmule
		/*0x02e8*/
	} CPLAYERWND, *PCPLAYERWND;

	// CTargetWindow__CTargetWindow aTargetwindow
	// CTargetWindow_size: 0x8c8 (see 56CDF7) in Nov  3 2021 Beta - eqmule
	typedef struct _CTARGETWND {
		...
		/*0x0854*/ int			LastBuffRecievedTime;
		/*0x0858*/ UINT			Timer;
		/*0x085c*/ HashTable<PCXSTR> Casters;
		/*0x086c*/ int			ContextMenuID;
		/*0x0870*/ PCXWND		RequestingWnd;
		/*0x0874*/ bool			bRemovedBuffBlockMenuItem;
	...
	// CBuffWindow_size: 0x718 (see 56CCAB) in Nov  3 2021 Beta - eqmule
	typedef struct _EQBUFFWINDOW {
		...
		/*0x70c*/ BYTE         Unknown0x070c[0xc];
		/*0x718*/
	} EQBUFFWINDOW, *PEQBUFFWINDOW;

	// CSpellGemWnd__CSpellGemWnd
	// Individual Gems 
	// CSpellGemWnd_size: 0x320 (see 84C1BD) in Nov  3 2021 Beta - eqmule
	...
	// CCastSpellWnd_size: 0x2d0 (see 56D03D) in Nov  3 2021 Beta - eqmule
	...
	// CInvSlotWnd_size: 0x2d0 (see 84C25B) in Nov  3 2021 Beta - eqmule
	typedef struct _EQINVSLOTWND {
		/*0x0000*/ struct _CBUTTONWND	ButtonWnd;
		/*0x0280*/ void					*pTABackground;//CTextureAnimation
		/*0x0284*/ LONG					Location; // Really this is a ItemGlobalIndex
		/*0x0288*/ short				Slot1;
		/*0x028a*/ short				Slot2;
		/*0x028c*/ short				Slot3;
		/*0x0290*/ VePointer<CONTENTS>  pItem;
		/*0x0294*/ int					ItemOffsetX;
		/*0x0298*/ int					ItemOffsetY;
		/*0x029c*/ void					*pTAItem;//CTextureAnimation
		/*0x02a0*/ int					Quantity;
		/*0x02a4*/ bool					bSelected;
		/*0x02a5*/ bool					bFindSelected;
		/*0x02a8*/ int					RecastLeft;
		/*0x02ac*/ bool					bHotButton;
		/*0x02ad*/ bool					bInventorySlotLinked;
		/*0x02b0*/ struct _EQINVSLOT	*pInvSlot;
		/*0x02b4*/ void					*pTextObject;//CTextObjectInterface
		/*0x02b8*/ int					TextFontStyle;//EFontStyles
		/*0x02bc*/ BOOL					ProcessClick;
		/*0x02c0*/ D3DCOLOR				BGTintRollover;
		/*0x02c4*/ D3DCOLOR				BGTintNormal;
		/*0x02c8*/ long					LastTime;
		/*0x02cc*/ long					Unknown0x02cc;
		/*0x02d0*/
	...
	// CItemDisplayWindow_size: 0x630 (see 7A2360) in Nov  3 2021 Beta - eqmule
	typedef struct _EQITEMWINDOW {
		/*0x0000*/ struct _CSIDLWND Wnd;
		/*0x0230*/ CBUTTONWND* Description;
		/*0x0234*/ struct _CSIDLWND *IconButton;
		/*0x0238*/ struct _CSIDLWND *ItemLore;
		/*0x023C*/ struct _CSIDLWND *ItemDescriptionTabBox;
		/*0x0240*/ struct _CSIDLWND *ItemDescriptionTab;
		/*0x0244*/ struct _CSIDLWND *ItemLoreTab;
		/*0x0248*/ struct _CSIDLWND *pAppearanceSocketScreen;
		/*0x024C*/ CBUTTONWND *pAppearanceSocketItem;
		/*0x0250*/ CBUTTONWND *pAppearanceSocketBuyButton;
		/*0x0254*/ struct _CSIDLWND *pAppearanceSocketDescription;
		/*0x0258*/ struct _CSIDLWND *pItemSocketScreen[6];
		/*0x0270*/ CBUTTONWND *pItemSocketItemButton[6];
		/*0x0288*/ struct _CSIDLWND *pItemSocketDescription[6];
		/*0x02A0*/ PCXSTR       ItemInfo;//this item is placable in yards, guild yards blah blah , This item can be used in tradeskills
		/*0x02A4*/ PCXSTR       Unknown0x02A4;//ADDED may 11 2021
		/*0x02A8*/ PCXSTR       Unknown0x02A8;//ADDED may 11 2021
		/*0x02AC*/ PCXSTR       WindowTitle;
		/*0x02B0*/ PCXSTR       ItemAdvancedLoreText;
		/*0x02B4*/ PCXSTR       ItemMadeByText;
		...
		/*0x02C8*/ void			*DragIcons;//CTextureAnimation
		/*0x02CC*/ bool			bTaggable;
		/*0x02CD*/ bool			bFailed;
		/*0x02D0*/ CLABEL		*ModButtonLabel;
		/*0x02D4*/ CSIDLWND		*RewardButtonLabel;
		/*0x02D8*/ CSIDLWND		*ConvertStml;
		/*0x02DC*/ CLABEL		*FuseLabel;
		/*0x02E0*/ CLABEL		*MadeByLabel;
		/*0x02E4*/ CLABEL		*CollectedLabel;
		/*0x02E8*/ CLABEL		*ScribedLabel;
		/*0x02EC*/ int			Row;
		/*0x02F0*/ bool			bAntiTwink;
		/*0x02F4*/ CBUTTONWND	*ModButton;
		/*0x02F8*/ CBUTTONWND	*RewardButton;
		/*0x02FC*/ CBUTTONWND	*PrintRealEstateItems;
		/*0x0300*/ CBUTTONWND	*ConvertButton;
		/*0x0304*/ CBUTTONWND	*FuseButton;
		...
		/*0x0318*/ int			Group[6];
		/*0x0330*/ int			HeroicLabelCount;
		/*0x0334*/ int			ItemInfoLabelCount;
		...
		/*0x0618*/ void			*pItemCompareList;//COMBOBOX
		/*0x061C*/ bool			bUnknown0x061C;//TODO: look into... well this was added in the apr 13 2021 test exe, the patchnotes says: -Added weapon ratio to the Item Display Window.
		/*0x0620*/ int			Unknown0x0620;//maybe that is this? -eqmule
		/*0x0624*/ int			FT_DefPageBorderHighlight;//https://forums.daybreakgames.com/eq/index.php?threads/test-update-04-13-21-patch-notes-and-discussions.274393/
		/*0x0628*/ int			FT_DefPageBorder;
		/*0x062C*/ int			ItemWndIndex;//0-5? you can have max 6 windows up I think before it starts overwriting the sixth.
		/*0x0630*/
	} EQITEMWINDOW, *PEQITEMWINDOW;

	//CLootWnd__CLootWnd aLootwnd
	// CLootWnd_size: 0x3a8 (see 56D38A) in Nov  3 2021 Beta - eqmule
	typedef struct _EQLOOTWINDOW {
		/*0x0000*/ struct _CSIDLWND     Wnd;
		/*0x0230*/ void* vftable; // for CLootWnd::DialogResponse handler
		/*0x0234*/ int	Unknown0x0234;
		/*0x0238*/ bool bUnlockSent;
		/*0x0239*/ bool bActivelyLooting;
		/*0x023c*/ int LootIndex[NUM_INV_SLOTS];
		/*0x02cc*/ unsigned int NextRefreshTime;
		/*0x02d0*/ bool bInventoryWasActive;
		union
		{
			/*0x02d4*/ ItemBaseContainer lootItems;//size 0x1c
			struct
			{
				/*0x02d4*/ DWORD		NumOfSlots;
				/*0x02d8*/ BYTE			Unknown0x002d8[0x4];
		...
		/*0x02f0*/ BYTE bUnknown0x02f0;//maybe
		/*0x02f1*/ bool bCloseOnComplete;//maybe
		/*0x02f2*/ bool bRightClickLoot;//maybe
		/*0x02f3*/ BYTE LootersLevel;//maybe
		/*0x02f4*/ struct _CSIDLWND *LootInvWnd;
		/*0x02f8*/ struct _CSILDWND *LootSlotWnd[NUM_INV_SLOTS];
	...
	// CMerchantWnd_size: 0x440 (see 56D4D6) in Nov  3 2021 Beta - eqmule
	typedef struct _EQMERCHWINDOW {
		/*0x0000*/ struct _CSIDLWND Wnd;
		/*0x0230*/ BYTE			Unknown0x0228[0x10];
		...
		/*0x0250*/ LONG			Location; // Really this is a ItemGlobalIndex
		/*0x0254*/ short		Slot1;
		/*0x0256*/ short		Slot2;
		/*0x0258*/ short		Slot3;
		/*0x025c*/ int			Unknown0x25c[0x2];
		/*0x0264*/ VePointer<CONTENTS>pSelectedItem;
		/*0x0268*/ BYTE			Unknown0x0268[0x1d8];
		/*0x0440*/
	} EQMERCHWINDOW, *PEQMERCHWINDOW;

	//CPetInfoWindow__CPetInfoWindow aPetinfowindow
	// CPetInfoWindow_size: 0x8c8 (see 56C5BB) in Nov  3 2021 Beta - eqmule
	...
	//aClasscolorD
	// CRaidWindow_size: 0x3a0 (see 56C888) in Nov  3 2021 Beta - eqmule
	...
	// CTradeWnd__size: 0x2f0 (see 56D574) in Nov  3 2021 Beta - eqmule
	...
	// CFactionWnd__size: 0x278 (see 56D6B0) in Nov  3 2021 Beta - eqmule
