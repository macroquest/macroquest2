...
//Actual Size: 0x100 (see 0x7FFD006586A0 in eqgame.exe Test dated Dec 14 2021) - eqmule
...
/*0x0018*/ int	ConvertItemID;
/*0x001C*/ int	OrnamentationIcon;
/*0x0020*/ int	StackCount;
/*0x0024*/ int	Power;
/*0x0028*/ ArrayClass_RO<UINT> RealEstateArray;
/*0x0038*/ bool	bRealEstateItemPlaceable;
/*0x0039*/ bool	bConvertable;
/*0x003A*/ bool	bDisableAugTexture;
/*0x003C*/ int	ScriptIndex;
/*0x0040*/ SharedPtr<ItemEvolutionData> pEvolutionData;
/*0x0048*/ int	RealEstateID;
/*0x004C*/ struct _CXSTR *ConvertItemName;
/*0x0050*/ UINT	LastCastTime;
/*0x0054*/ UINT	RespawnTime;
/*0x0058*/ struct _ITEMINFO *Item1;
/*0x005C*/ bool	bCopied;
/*0x005D*/ bool	bRankDisabled;
/*0x0060*/ __int64 MerchantSlot;
/*0x0068*/ bool	bItemNeedsUpdate;
/*0x006C*/ int	MerchantQuantity;
/*0x0070*/ struct _CXSTR *	ActorTag2;
/*0x0074*/ UINT	Tint;
/*0x0078*/ int	NoDropFlag;
/*0x007C*/ UINT	ItemHash;
/*0x0080*/ int	AugFlag;
/*0x0084*/ int	NoteStatus;
/*0x0088*/ int	ID;
/*0x008C*/ UINT	NewArmorID;
/*0x0090*/ struct _CXSTR *	ActorTag1;
/*0x0098*/ __int64	DontKnow;
/*0x00A0*/ ItemBaseContainer2 Contents; /* Size is 0x1c */
/*0x00BC*/ bool	bCollected;
/*0x00C0*/ __int64 Price;
/*0x00C8*/ int	Luck;
/*0x00CC*/ int	ArmorType;
/*0x00D0*/ int	Charges;
/*0x00D4*/ struct _CXSTR *SaveString;
/*0x00D8*/ int	Open;
/*0x00DC*/ EqItemGuid ItemGUID;
//start of ItemClient
/*0x00F0*/ int Filler0x00F0;
...
//aStartingLoad
#define CHARINFO_Size 0x2BF4 //in Nov 30 2021 test (see 62686E) - SwiftyMUSE
...
#define EQ_ASSIST_COMPLETE              0x3E62   // aMsgTimeStampRe
#define EQ_ASSIST                       0x606C   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
