...
//Actual Size: 0x110 (see 0x65A650 in eqgame.exe Test dated Apr 27 2021) - eqmule
...
/*0x0034*/ int	AugFlag;
/*0x0038*/ int	RealEstateID;
/*0x003C*/ bool	bCollected;
/*0x0040*/ int	Luck;
/*0x0044*/ int	OrnamentationIcon;
/*0x0048*/ struct _CXSTR *	ActorTag1;
/*0x0050*/ __int64 Price;
/*0x0058*/ int	ConvertItemID;
/*0x005C*/ ItemGlobalIndex2 GlobalIndex; /* Size is 0xa (0xc)*/
/*0x0068*/ bool	bCopied;
/*0x006C*/ int	ScriptIndex;
/*0x0070*/ int	ID;
/*0x0074*/ UINT	ItemHash;
/*0x0078*/ bool	bRankDisabled;
/*0x007C*/ int	NoteStatus;
/*0x0080*/ UINT	RespawnTime;
/*0x0084*/ int	Charges;
/*0x0088*/ SharedPtr<ItemEvolutionData> pEvolutionData;
/*0x0090*/ int	ArmorType;
/*0x0094*/ UINT	NewArmorID;
/*0x0098*/ struct _CXSTR *SaveString;
/*0x009C*/ bool	bDisableAugTexture;
/*0x00A0*/ __int64	DontKnow;
/*0x00A8*/ EqItemGuid ItemGUID;
/*0x00BA*/ bool	bRealEstateItemPlaceable;
/*0x00BC*/ struct _CXSTR *	ActorTag2;
/*0x00C0*/ UINT	LastCastTime;
/*0x00C4*/ int	Power;
/*0x00C8*/ struct _ITEMINFO *Item1;
/*0x00CC*/ ArrayClass_RO<UINT> RealEstateArray;
/*0x00DC*/ UINT	Tint;
/*0x00E0*/ bool	bItemNeedsUpdate;
/*0x00E4*/ int	Open;
/*0x00E8*/ bool	bConvertable;
/*0x00EC*/ int	StackCount;
/*0x00F0*/ int	NoDropFlag;
/*0x00F4*/ int	MerchantQuantity;
/*0x00F8*/ struct _CXSTR *ConvertItemName;
//start of ItemClient
...
/*0x0604*/ //I wont finetune these comments every single patch cause they change since PLAYERZONECLIENT size change...
/*0x0604*/ TCircularBuffer<SDoCollisionMovementStats, 0x14>MovementStats; /* size (0x74 * 0x14) +8 = 0x918 */
/*0x0f1c*/ struct _SPAWNINFO*   WhoFollowing; // NULL if autofollow off
/*0x0f20*/ DWORD	GroupAssistNPC[0x1];
/*0x0f24*/ DWORD	RaidAssistNPC[0x3];
/*0x0f30*/ DWORD	GroupMarkNPC[0x3];
/*0x0f3c*/ DWORD	RaidMarkNPC[0x3];
/*0x0f48*/ DWORD	TargetOfTarget;
...
#define EQ_ASSIST_COMPLETE              0x400A   // aMsgTimeStampRe
#define EQ_ASSIST                       0x086A   // do_assist(PlayerClient *,char const *)+399 20160212 live (see 52C319)
