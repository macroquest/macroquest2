...
// actual size 0x1F0 in Jun 23 2021 Test (see 0x99F57B) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ UINT		FadeDuration; \
/*0x0020*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0024*/ bool		bMarkedForDelete; \
/*0x0028*/ void*	pTextObject; \
/*0x002C*/ void	    *pFont; \
/*0x0030*/ bool		bClientClipRectChanged; \
/*0x0034*/ int	Transition; \
/*0x0038*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x003C*/ UINT		TransitionStartTick; \
/*0x0040*/ bool		bFullyScreenClipped; \
/*0x0044*/ DWORD	LastTimeMouseOver; \
/*0x0048*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x004C*/ int		BlinkState; \
/*0x0050*/ DWORD  BackgroundDrawType; \
/*0x0054*/ int		ParentAndContextMenuArrayIndex; \
/*0x0058*/ int		BottomOffset; \
/*0x005C*/ bool		bUseInLayoutHorizontal; \
/*0x005D*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0060*/ __int64		Data; \
/*0x0068*/ int		VScrollPos; \
/*0x006C*/ void		*pLayoutStrategy; \
/*0x0070*/ bool		bAction; \
/*0x0074*/ int		HScrollPos; \
/*0x0078*/ bool		bBorder; \
/*0x007C*/ void   *TitlePiece; \
/*0x0080*/ void *pController; \
/*0x0084*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0088*/ bool		bActive; \
/*0x008C*/ DWORD	FadeDelay; \
/*0x0090*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0094*/ bool		bClipToParent; \
/*0x0098*/ UINT		BlinkFadeFreq; \
/*0x009C*/ bool		bTopAnchoredToTop; \
/*0x009D*/ bool		bTiled; \
/*0x009E*/ bool		bLeftAnchoredToLeft; \
/*0x00A0*/ RECT		TransitionRect; \
/*0x00B0*/ tagSIZE	MinClientSize; \
/*0x00B8*/ RECT		ClientRect; \
/*0x00C8*/ RECT		ClipRectScreen; \
/*0x00D8*/ int		LeftOffset; \
/*0x00DC*/ bool		bClientRectChanged; \
/*0x00DD*/ BYTE		FadeAlpha; \
/*0x00DE*/ bool		bIsTransitioning; \
/*0x00E0*/ int		HScrollMax; \
/*0x00E4*/ BYTE     bResizableMask; \
/*0x00E8*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00EC*/ BYTE		StartAlpha; \
/*0x00ED*/ bool		bBringToTopWhenClicked; \
/*0x00F0*/ struct _CXSTR*	DataStr; \
/*0x00F4*/ int		TopOffset; \
/*0x00F8*/ tagSIZE	MaxClientSize; \
/*0x0100*/ bool		Fades; \
/*0x0101*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0104*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0108*/ bool		bBorder2; \
/*0x010C*/ UINT		BlinkFadeDuration; \
/*0x0110*/ BYTE		TargetAlpha; \
/*0x0111*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0114*/ int		managerArrayIndex; \
/*0x0118*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0119*/ bool		bHCenterTooltip; \
/*0x011C*/ int		RightOffset; \
/*0x0120*/ bool		bKeepOnScreen; \
/*0x0121*/ bool		Minimized; \
/*0x0122*/ bool		Enabled; \
/*0x0124*/ LONG		BlinkStartTimer; \
/*0x0128*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x012C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x012D*/ bool		bBottomAnchoredToTop; \
/*0x012E*/ BYTE		Alpha; \
/*0x0130*/ RECT		OldLocation; \
/*0x0140*/ bool		bMaximized; \
/*0x0144*/ void	*IconTextureAnim; \
/*0x0148*/ DWORD	XMLIndex; \
/*0x014C*/ RECT		Location; \
/*0x015C*/ int		DeleteCount; \
/*0x0160*/ bool		bScreenClipRectChanged; \
/*0x0164*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0168*/ bool		bIsParentOrContextMenuWindow; \
/*0x0169*/ bool		bMaximizable; \
/*0x016A*/ bool		dShow; \
/*0x016C*/ void* pTipTextObject; \
/*0x0170*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0171*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0174*/ int		VScrollMax; \
/*0x0178*/ RECT		IconRect; \
/*0x0188*/ UINT		TransitionDuration; \
/*0x018C*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0190*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0194*/ COLORREF DisabledBackground; \
/*0x0198*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x019C*/ bool		bCaptureTitle; \
/*0x019D*/ bool		bRightAnchoredToLeft; \
/*0x019E*/ bool		Faded; \
/*0x01A0*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x01B8*/ void	*DrawTemplate; \
/*0x01BC*/ bool		bUseInLayoutVertical; \
/*0x01C0*/ void   *TitlePiece2; \
/*0x01C4*/ RECT		ClipRectClient; \
/*0x01D4*/ bool		bEscapableLocked; \
/*0x01D8*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01DC*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01E0*/ UINT		BlinkFadeStartTime; \
...
// CBazaarSearchWnd_size: 0x95f8 (see 56FC72) in Jun 23 2021 Test - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 56F5B0) in Jun 23 2021 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 56F457) in Jun 23 2021 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 56F30B) in Jun 23 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 84C4FD) in Jun 23 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 56F69D) in Jun 23 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 84C598) in Jun 23 2021 Test - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 7A2CF0) in Jun 23 2021 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 56F9EA) in Jun 23 2021 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 56F180) in Jun 23 2021 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 56FB36) in Jun 23 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 56EC1B) in Jun 23 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 56EEE8) in Jun 23 2021 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 56FBD4) in Jun 23 2021 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 56FD10) in Jun 23 2021 Test - eqmule
