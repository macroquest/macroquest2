...
/*0x0020*/ RECT		Location; \
/*0x0030*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0031*/ BYTE		Alpha; \
/*0x0032*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0033*/ bool		bRightAnchoredToLeft; \
/*0x0034*/ bool		bCaptureTitle; \
/*0x0035*/ bool		Faded; \
/*0x0036*/ bool		bEscapableLocked; \
/*0x0037*/ bool		Fades; \
/*0x0038*/ BYTE		FadeAlpha; \
/*0x003C*/ int		RightOffset; \
/*0x0040*/ int		LeftOffset; \
/*0x0044*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0048*/ bool		bTiled; \
/*0x004C*/ UINT		TransitionDuration; \
/*0x0050*/ int		TopOffset; \
/*0x0054*/ bool		bBringToTopWhenClicked; \
/*0x0058*/ void   *TitlePiece; \
/*0x005C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0060*/ bool		bKeepOnScreen; \
/*0x0064*/ COLORREF DisabledBackground; \
/*0x0068*/ void	*IconTextureAnim; \
/*0x006C*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0070*/ bool		bAction; \
/*0x0074*/ int		ParentAndContextMenuArrayIndex; \
...
/*0x0081*/ bool		bTopAnchoredToTop; \
/*0x0084*/ void   *TitlePiece2; \
/*0x0088*/ RECT		ClipRectClient; \
/*0x0098*/ UINT		LastBlinkFadeRefreshTime; \
/*0x009C*/ int		BlinkState; \
/*0x00A0*/ bool		bHCenterTooltip; \
/*0x00A1*/ bool		bClipToParent; \
/*0x00A2*/ bool		bIsParentOrContextMenuWindow; \
/*0x00A3*/ bool		bUseInLayoutHorizontal; \
/*0x00A4*/ DWORD  BackgroundDrawType; \
/*0x00A8*/ void*	pTextObject; \
/*0x00AC*/ void	*DrawTemplate; \
/*0x00B0*/ bool		bUseInLayoutVertical; \
/*0x00B4*/ void		*pLayoutStrategy; \
/*0x00B8*/ RECT		OldLocation; \
/*0x00C8*/ bool		bLeftAnchoredToLeft; \
/*0x00CC*/ DWORD	XMLIndex; \
/*0x00D0*/ BYTE		StartAlpha; \
/*0x00D4*/ int		BottomOffset; \
/*0x00D8*/ bool		Enabled; \
/*0x00E0*/ __int64		Data; \
/*0x00E8*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00EC*/ void	    *pFont; \
/*0x00F0*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x00F4*/ DWORD	FadeDelay; \
/*0x00F8*/ UINT		BlinkFadeFreq; \
/*0x00FC*/ bool		bScreenClipRectChanged; \
/*0x0100*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0104*/ UINT		BlinkFadeStartTime; \
/*0x0108*/ bool		bBorder2; \
/*0x0109*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x010C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0110*/ int		VScrollMax; \
/*0x0114*/ bool		bMaximizable; \
/*0x0118*/ DWORD	LastTimeMouseOver; \
/*0x011C*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x011D*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0120*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0138*/ RECT		ClipRectScreen; \
/*0x0148*/ UINT		FadeDuration; \
/*0x014C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0150*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0154*/ tagSIZE	MaxClientSize; \
/*0x015C*/ bool		bBorder; \
/*0x015D*/ bool		bMaximized; \
/*0x0160*/ RECT		ClientRect; \
/*0x0170*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0174*/ bool		bMarkedForDelete; \
/*0x0178*/ int		managerArrayIndex; \
/*0x017C*/ bool		Minimized; \
/*0x0180*/ RECT		IconRect; \
/*0x0190*/ int		BlinkDuration; \
/*0x0194*/ bool		bFullyScreenClipped; \
/*0x0195*/ BYTE     bResizableMask; \
/*0x0198*/ LONG		BlinkStartTimer; \
/*0x019C*/ bool		dShow; \
/*0x01A0*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01A4*/ UINT		BlinkFadeDuration; \
/*0x01A8*/ bool		bIsTransitioning; \
/*0x01A9*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x01AC*/ void* pTipTextObject; \
/*0x01B0*/ void *pController; \
/*0x01B4*/ BYTE		TargetAlpha; \
/*0x01B5*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01B8*/ int		HScrollPos; \
/*0x01BC*/ int		DeleteCount; \
/*0x01C0*/ int	Transition; \
/*0x01C4*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x01C5*/ bool		bClientClipRectChanged; \
/*0x01C8*/ UINT		TransitionStartTick; \
/*0x01CC*/ int		VScrollPos; \
/*0x01D0*/ bool		bActive; \
/*0x01D4*/ tagSIZE	MinClientSize; \
/*0x01DC*/ bool		bClientRectChanged; \
/*0x01E0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01E4*/ RECT		TransitionRect; \
...
// CBazaarSearchWnd_size: 0x9600 (see 56FDC2) in Aug 10 2021 Test - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f8 (see 56F700) in Aug 10 2021 Test - eqmule
...
// CTargetWindow_size: 0x8d8 (see 56F5A7) in Aug 10 2021 Test - eqmule
...
// CBuffWindow_size: 0x728 (see 56F45B) in Aug 10 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 84C047) in Aug 10 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 56F7ED) in Aug 10 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 84C0E5) in Aug 10 2021 Test - eqmule
...
// CItemDisplayWindow_size: 0x640 (see 7A26B0) in Aug 10 2021 Test - eqmule
...
// CLootWnd_size: 0x3a8 (see 56FB3A) in Aug 10 2021 Test - eqmule
...
// CMapViewWnd_size: 0x668 (see 56F2D0) in Aug 10 2021 Test - eqmule
...
// CMerchantWnd_size: 0x450 (see 56FC86) in Aug 10 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 56ED6B) in Aug 10 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 56F038) in Aug 10 2021 Test - eqmule
...
// CTradeWnd__size: 0x300 (see 56FD24) in Aug 10 2021 Test - eqmule
...
// CFactionWnd__size: 0x288 (see 56FE60) in Aug 10 2021 Test - eqmule
