...
// actual size 0x1E8 in Mar  2 2021 Test (see 0x9935DB) - eqmule
...
/*0x0020*/ int		ParentAndContextMenuArrayIndex; \
/*0x0024*/ int		LeftOffset; \
/*0x0028*/ UINT		BlinkFadeDuration; \
/*0x002C*/ RECT		IconRect; \
/*0x003C*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0054*/ RECT		Location; \
/*0x0064*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0068*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x006C*/ int		BottomOffset; \
/*0x0070*/ void	*IconTextureAnim; \
/*0x0074*/ RECT		TransitionRect; \
/*0x0084*/ bool		bFullyScreenClipped; \
/*0x0085*/ bool		bScreenClipRectChanged; \
/*0x0086*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x0087*/ bool		bHCenterTooltip; \
/*0x0088*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0089*/ bool		bKeepOnScreen; \
/*0x008A*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x008B*/ bool		bUseInLayoutVertical; \
/*0x008C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0090*/ bool		bEscapableLocked; \
/*0x0094*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0098*/ bool		bLeftAnchoredToLeft; \
/*0x0099*/ bool		Minimized; \
/*0x009C*/ void		*pLayoutStrategy; \
/*0x00A0*/ DWORD	FadeDelay; \
/*0x00A4*/ RECT		ClientRect; \
/*0x00B4*/ UINT		FadeDuration; \
/*0x00B8*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x00BC*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00C0*/ DWORD	LastTimeMouseOver; \
/*0x00C4*/ bool		bBorder; \
/*0x00C5*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00C6*/ BYTE		FadeAlpha; \
/*0x00C8*/ int		HScrollMax; \
/*0x00CC*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00D0*/ UINT		TransitionDuration; \
/*0x00D4*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00D8*/ void*	pTextObject; \
/*0x00DC*/ int		DeleteCount; \
/*0x00E0*/ int		managerArrayIndex; \
/*0x00E4*/ bool		bUseInLayoutHorizontal; \
/*0x00E5*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x00E8*/ void	    *pFont; \
/*0x00EC*/ DWORD	XMLIndex; \
/*0x00F0*/ RECT		ClipRectScreen; \
/*0x0100*/ bool		bTopAnchoredToTop; \
/*0x0104*/ int		BlinkState; \
/*0x0108*/ bool		Faded; \
/*0x010C*/ RECT		ClipRectClient; \
/*0x011C*/ DWORD  BackgroundDrawType; \
/*0x0120*/ bool		bClientRectChanged; \
/*0x0124*/ int	Transition; \
/*0x0128*/ struct _CXSTR*	DataStr; \
/*0x012C*/ bool		bAction; \
/*0x0130*/ void* pTipTextObject; \
/*0x0134*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0138*/ tagSIZE	MinClientSize; \
/*0x0140*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0144*/ bool		bBottomAnchoredToTop; \
/*0x0148*/ void *pController; \
/*0x014C*/ BYTE		TargetAlpha; \
/*0x0150*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0154*/ RECT		OldLocation; \
/*0x0164*/ UINT		TransitionStartTick; \
/*0x0168*/ BYTE		StartAlpha; \
/*0x0169*/ bool		Fades; \
/*0x016C*/ void   *TitlePiece2; \
/*0x0170*/ bool		bIsTransitioning; \
/*0x0174*/ int		TopOffset; \
/*0x0178*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0179*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x017C*/ LONG		BlinkStartTimer; \
/*0x0180*/ void   *TitlePiece; \
/*0x0184*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0188*/ UINT		BlinkFadeFreq; \
/*0x018C*/ UINT		BlinkFadeStartTime; \
/*0x0190*/ bool		bClipToParent; \
/*0x0194*/ tagSIZE	MaxClientSize; \
/*0x019C*/ bool		bMarkedForDelete; \
/*0x019D*/ bool		bTiled; \
/*0x019E*/ bool		bBringToTopWhenClicked; \
/*0x019F*/ bool		bMaximized; \
/*0x01A0*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01A4*/ int		RightOffset; \
/*0x01A8*/ int		HScrollPos; \
/*0x01AC*/ int		BlinkDuration; \
/*0x01B0*/ bool		Enabled; \
/*0x01B1*/ bool		bIsParentOrContextMenuWindow; \
/*0x01B2*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01B3*/ BYTE     bResizableMask; \
/*0x01B4*/ bool		bClientClipRectChanged; \
/*0x01B5*/ BYTE		Alpha; \
/*0x01B6*/ bool		bBorder2; \
/*0x01B7*/ bool		dShow; \
...
/*0x01C0*/ bool		bMaximizable; \
/*0x01C1*/ bool		bRightAnchoredToLeft; \
/*0x01C2*/ bool		bActive; \
/*0x01C4*/ int		VScrollPos; \
/*0x01C8*/ COLORREF DisabledBackground; \
/*0x01CC*/ int		VScrollMax; \
/*0x01D0*/ __int64		Data; \
/*0x01D8*/ \
public: \
			bool IsVisible() \
...
/*0x0230*/ void*	Unknown0x230;//most likely a CTextureAnimation*
/* CButtonDrawTemplate Start */
/*0x0234*/ PCXSTR	Name;
/*0x0238*/ void*	Normal;//CTextureAnimation
/*0x023c*/ void*	taPressed;
/*0x0240*/ void*	Flyby;
/*0x0244*/ void*	taDisabled;
/*0x0248*/ void*	PressedFlyby;
/*0x024c*/ void*	PressedDisabled;
/*0x0250*/ void*	NormalDecal;
/*0x0254*/ void*	PressedDecal;
/*0x0258*/ void*	FlybyDecal;
/*0x025c*/ void*	DisabledDecal;
/*0x0260*/ void*	PressedFlybyDecal;
/*0x0264*/ void*	PressedDisabledDecal;
/*0x0268*/ bool		bAllowButtonClickThrough;
/*0x0269*/ bool		bCoolDownDoDelayedStart;
/*0x026a*/ bool		bIsCheckbox;
/*0x026b*/ bool		bIsDrawLasso;
/*0x026c*/ UINT		ButtonStyle;
/*0x0270*/
...
// CBazaarSearchWnd_size: 0x95e0 (see 56F942) in May 11 2021 Test - eqmule
typedef struct _BAZAARSEARCHWND {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0220*/ BYTE         Unknown0x0220[0x9318];
/*0x9538*/ void**       ppTraderData;
/*0x953C*/ DWORD        hashVal;//find in CBazaarSearchWnd__HandleSearchResults_x
/*0x9540*/ BYTE         Unknown0x9540[0xa0];
/*0x95E0*/
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2d8 (see 56F280) in May 11 2021 Test - eqmule
...
/*0x02d4*/ DWORD		Unknown0x02d4;// added aug 11 2020 Test - eqmule
/*0x02d8*/
} CPLAYERWND, *PCPLAYERWND;

// CTargetWindow__CTargetWindow_x aTargetwindow
// CTargetWindow_size: 0x8b8 (see 56F127) in May 11 2021 Test - eqmule
...
/*0x0844*/ int			LastBuffRecievedTime;
/*0x0848*/ UINT			Timer;
/*0x084c*/ HashTable<PCXSTR> Casters;
/*0x085c*/ int			ContextMenuID;
/*0x0860*/ PCXWND		RequestingWnd;
/*0x0864*/ bool			bRemovedBuffBlockMenuItem;
...
// CBuffWindow_size: 0x708 (see 56EFDB) in May 11 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x310 (see 84BF3D) in May 11 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2c0 (see 56F36D) in May 11 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2c0 (see 84BFD8) in May 11 2021 Test - eqmule
typedef struct _EQINVSLOTWND {
/*0x0000*/ struct _CBUTTONWND	ButtonWnd;
/*0x0270*/ void*				pTABackground;//CTextureAnimation
/*0x0274*/ LONG					Location; // Really this is a ItemGlobalIndex
/*0x0278*/ short				Slot1;
/*0x027a*/ short				Slot2;
/*0x027c*/ short				Slot3;
/*0x0280*/ VePointer<CONTENTS>  pItem;
/*0x0284*/ int					ItemOffsetX;
/*0x0288*/ int					ItemOffsetY;
/*0x028c*/ void*				pTAItem;//CTextureAnimation
/*0x0290*/ int					Quantity;
/*0x0294*/ bool					bSelected;
/*0x0295*/ bool					bFindSelected;
/*0x0298*/ int					RecastLeft;
/*0x029c*/ bool					bHotButton;
/*0x029d*/ bool					bInventorySlotLinked;
/*0x02a0*/ struct _EQINVSLOT*	pInvSlot;
/*0x02a4*/ void*				pTextObject;//CTextObjectInterface
/*0x02a8*/ int					TextFontStyle;//EFontStyles
/*0x02ac*/ BOOL					ProcessClick;
/*0x02b0*/ D3DCOLOR				BGTintRollover;
/*0x02b4*/ D3DCOLOR				BGTintNormal;
/*0x02b8*/ long					LastTime;
/*0x02bc*/ long					Unknown0x02bc;
/*0x02c0*/
...
// CItemDisplayWindow_size: 0x620 (see 7A2550) in May 11 2021 Test - eqmule
typedef struct _EQITEMWINDOW {
/*0x0000*/ struct _CSIDLWND Wnd;
/*0x0220*/ CBUTTONWND *Description;
...
/*0x0238*/ struct _CSIDLWND *pAppearanceSocketScreen;
/*0x023C*/ CBUTTONWND *pAppearanceSocketItem;
/*0x0240*/ CBUTTONWND *pAppearanceSocketBuyButton;
/*0x0244*/ struct _CSIDLWND *pAppearanceSocketDescription;
/*0x0248*/ struct _CSIDLWND *pItemSocketScreen[6];
/*0x0260*/ CBUTTONWND *pItemSocketItemButton[6];
/*0x0278*/ struct _CSIDLWND *pItemSocketDescription[6];
/*0x0290*/ PCXSTR       ItemInfo;//this item is placable in yards, guild yards blah blah , This item can be used in tradeskills
/*0x0294*/ PCXSTR       Unknown0x0294;//ADDED may 11 2021
/*0x0298*/ PCXSTR       Unknown0x0298;//ADDED may 11 2021
...
/*0x02B8*/ void			*DragIcons;//CTextureAnimation
/*0x02BC*/ bool			bTaggable;
/*0x02BD*/ bool			bFailed;
/*0x02C0*/ CLABEL		*ModButtonLabel;
/*0x02C4*/ CSIDLWND		*RewardButtonLabel;
/*0x02C8*/ CSIDLWND		*ConvertStml;
/*0x02CC*/ CLABEL		*FuseLabel;
/*0x02D0*/ CLABEL		*MadeByLabel;
/*0x02D4*/ CLABEL		*CollectedLabel;
/*0x02D8*/ CLABEL		*ScribedLabel;
/*0x02DC*/ int			Row;
/*0x02E0*/ bool			bAntiTwink;
/*0x02E4*/ CBUTTONWND	*ModButton;
/*0x02E8*/ CBUTTONWND	*RewardButton;
/*0x02EC*/ CBUTTONWND	*PrintRealEstateItems;
/*0x02F0*/ CBUTTONWND	*ConvertButton;
...
/*0x0308*/ int			Group[6];
/*0x0320*/ int			HeroicLabelCount;
/*0x0324*/ int			ItemInfoLabelCount;
/*0x0328*/ CLABEL		*pItemInfoLabel[0xd];
...
/*0x0608*/ void			*pItemCompareList;//COMBOBOX
/*0x060C*/ bool			bUnknown0x060C;//TODO: look into... well this was added in the apr 13 2021 test exe, the patchnotes says: -Added weapon ratio to the Item Display Window.
/*0x0610*/ int			Unknown0x0610;//maybe that is this? -eqmule
/*0x0614*/ int			FT_DefPageBorderHighlight;//https://forums.daybreakgames.com/eq/index.php?threads/test-update-04-13-21-patch-notes-and-discussions.274393/
/*0x0618*/ int			FT_DefPageBorder;
/*0x061C*/ int			ItemWndIndex;//0-5? you can have max 6 windows up I think before it starts overwriting the sixth.
/*0x0620*/
} EQITEMWINDOW, *PEQITEMWINDOW;

//CLootWnd__CLootWnd aLootwnd
// CLootWnd_size: 0x388 (see 56F6BA) in May 11 2021 Test - eqmule
...
// CMapViewWnd_size: 0x628 (see 56EE50) in May 11 2021 Test - eqmule
...
// CMerchantWnd_size: 0x438 (see 56F806) in May 11 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8b8 (see 56E8EB) in May 11 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x390 (see 56EBB8) in May 11 2021 Test - eqmule
typedef struct _EQRAIDWINDOW {
/*0x0000*/ struct _CSIDLWND     Wnd;
/*0x0220*/ BYTE         Unknown0x0220[0xb0];
/*0x02d0*/ DWORD        ClassColors[0x10];
/*0x0310*/ BYTE         Unknown0x0310[0x80];
/*0x0390*/
} EQRAIDWINDOW, *PEQRAIDWINDOW;

//CTradeWnd__CTradeWnd aTradewnd
// CTradeWnd__size: 0x2e0 (see 56F8A4) in May 11 2021 Test - eqmule
...
// CFactionWnd__size: 0x268 (see 56F9E0) in May 11 2021 Test - eqmule
