...
/*0x001D*/ bool		bIsParentOrContextMenuWindow; \
/*0x001E*/ bool		bBorder2; \
/*0x001F*/ bool		bMaximizable; \
/*0x0020*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0024*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0028*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x002C*/ bool		bCaptureTitle; \
/*0x002D*/ bool		Enabled; \
/*0x0030*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0034*/ LONG		BlinkStartTimer; \
/*0x0038*/ int		BlinkState; \
/*0x003C*/ int		HScrollMax; \
/*0x0040*/ bool		bRightAnchoredToLeft; \
/*0x0041*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0044*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x005C*/ bool		Fades; \
/*0x005D*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x0060*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
...
/*0x0070*/ DWORD	LastTimeMouseOver; \
/*0x0074*/ bool		bBottomAnchoredToTop; \
/*0x0075*/ bool		bTiled; \
/*0x0078*/ int		managerArrayIndex; \
/*0x007C*/ bool		dShow; \
/*0x007D*/ bool		Faded; \
/*0x0080*/ tagSIZE	MaxClientSize; \
/*0x0088*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x008C*/ int		TopOffset; \
/*0x0090*/ void   *TitlePiece; \
/*0x0094*/ BYTE		TargetAlpha; \
/*0x0095*/ bool		bFullyScreenClipped; \
/*0x0098*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x009C*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00A0*/ void	    *pFont; \
/*0x00A4*/ UINT		BlinkFadeFreq; \
/*0x00A8*/ UINT		BlinkFadeDuration; \
/*0x00AC*/ void		*pLayoutStrategy; \
/*0x00B0*/ int		DeleteCount; \
/*0x00B4*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00B8*/ void   *TitlePiece2; \
/*0x00BC*/ RECT		ClipRectScreen; \
/*0x00CC*/ BYTE		StartAlpha; \
/*0x00CD*/ bool		bLeftAnchoredToLeft; \
/*0x00D0*/ void*	pTextObject; \
...
/*0x00D8*/ bool		bKeepOnScreen; \
/*0x00D9*/ bool		bMaximized; \
/*0x00DA*/ BYTE		Alpha; \
/*0x00DB*/ bool		bMarkedForDelete; \
/*0x00DC*/ bool		bIsTransitioning; \
/*0x00E0*/ struct _CXSTR*	DataStr; \
/*0x00E4*/ bool		bBorder; \
/*0x00E5*/ bool		Minimized; \
/*0x00E6*/ bool		bUseInLayoutVertical; \
/*0x00E8*/ RECT		IconRect; \
/*0x00F8*/ bool		bClientClipRectChanged; \
/*0x00F9*/ bool		bEscapableLocked; \
/*0x00FC*/ DWORD	FadeDelay; \
/*0x0100*/ bool		bScreenClipRectChanged; \
/*0x0104*/ void *pController; \
/*0x0108*/ RECT		TransitionRect; \
/*0x0118*/ RECT		ClientRect; \
/*0x0128*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0129*/ bool		bActive; \
/*0x012C*/ int		VScrollMax; \
/*0x0130*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x0134*/ RECT		Location; \
/*0x0144*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0148*/ void	*DrawTemplate; \
/*0x014C*/ BYTE     bResizableMask; \
/*0x0150*/ COLORREF DisabledBackground; \
/*0x0154*/ DWORD  BackgroundDrawType; \
/*0x0158*/ int		BottomOffset; \
/*0x015C*/ tagSIZE	MinClientSize; \
/*0x0164*/ UINT		FadeDuration; \
/*0x0168*/ RECT		ClipRectClient; \
/*0x0178*/ UINT		TransitionDuration; \
/*0x017C*/ void	*IconTextureAnim; \
/*0x0180*/ BYTE		FadeAlpha; \
/*0x0181*/ bool		bUseInLayoutHorizontal; \
/*0x0182*/ bool		bHCenterTooltip; \
/*0x0183*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0188*/ __int64		Data; \
/*0x0190*/ int		LeftOffset; \
/*0x0194*/ bool		bAction; \
/*0x0195*/ bool		bClientRectChanged; \
/*0x0196*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0198*/ int		HScrollPos; \
/*0x019C*/ int		ParentAndContextMenuArrayIndex; \
/*0x01A0*/ bool		bClipToParent; \
/*0x01A4*/ int		BlinkDuration; \
/*0x01A8*/ RECT		OldLocation; \
/*0x01B8*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x01BC*/ int		VScrollPos; \
/*0x01C0*/ int	Transition; \
/*0x01C4*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x01C8*/ UINT		TransitionStartTick; \
/*0x01CC*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01D0*/ int		RightOffset; \
/*0x01D4*/ bool		bTopAnchoredToTop; \
/*0x01D8*/ DWORD	XMLIndex; \
/*0x01DC*/ void* pTipTextObject; \
/*0x01E0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95e8 (see 56FCB2) in Jul 13 2021 Test - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2e0 (see 56F5F0) in Jul 13 2021 Test - eqmule
...
// CTargetWindow_size: 0x8c0 (see 56F497) in Jul 13 2021 Test - eqmule
...
// CBuffWindow_size: 0x710 (see 56F34B) in Jul 13 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x318 (see 84BF3D) in Jul 13 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2c8 (see 56F6DD) in Jul 13 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2c8 (see 84BFD8) in Jul 13 2021 Test - eqmule
...
// CItemDisplayWindow_size: 0x628 (see 7A2610) in Jul 13 2021 Test - eqmule
...
// CLootWnd_size: 0x390 (see 56FA2A) in Jul 13 2021 Test - eqmule
...
// CMapViewWnd_size: 0x638 (see 56F1C0) in Jul 13 2021 Test - eqmule
...
// CMerchantWnd_size: 0x438 (see 56FB76) in Jul 13 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8c0 (see 56EC5B) in Jul 13 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x398 (see 56EF28) in Jul 13 2021 Test - eqmule
...
// CTradeWnd__size: 0x2e8 (see 56FC14) in Jul 13 2021 Test - eqmule
...
// CFactionWnd__size: 0x270 (see 56FD50) in Jul 13 2021 Test - eqmule
