...
// actual size 0x1F8 in Mar  4 2021 Test (see 0x992BDB) - eqmule
// actual size 0x1E0 in Mar 16 2021 Test (see 0x992B9B) - eqmule
// actual size 0x1F0 in Apr 27 2021 Test (see 0x994C2B) - eqmule
...
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x0020*/ int		VScrollPos; \
/*0x0024*/ bool		bLeftAnchoredToLeft; \
/*0x0028*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x002C*/ void	*DrawTemplate; \
/*0x0030*/ RECT		TransitionRect; \
/*0x0040*/ DWORD	XMLIndex; \
/*0x0044*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0048*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x004C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0050*/ struct _CXSTR*	DataStr; \
/*0x0054*/ RECT		ClipRectScreen; \
/*0x0064*/ bool		bBorder2; \
/*0x0065*/ bool		bClipToParent; \
/*0x0068*/ RECT		Location; \
/*0x0078*/ bool		bClientClipRectChanged; \
/*0x007C*/ void* pTipTextObject; \
/*0x0080*/ BYTE		Alpha; \
/*0x0081*/ bool		bIsTransitioning; \
/*0x0082*/ bool		bBottomAnchoredToTop; \
/*0x0084*/ int		BlinkDuration; \
/*0x0088*/ UINT		BlinkFadeStartTime; \
/*0x008C*/ BYTE		TargetAlpha; \
/*0x0090*/ int		LeftOffset; \
/*0x0094*/ bool		bTiled; \
/*0x0098*/ void	*IconTextureAnim; \
/*0x009C*/ bool		bMaximized; \
/*0x009D*/ bool		bHCenterTooltip; \
/*0x00A0*/ int		VScrollMax; \
/*0x00A4*/ UINT		LastBlinkFadeRefreshTime; \
/*0x00A8*/ DWORD	FadeDelay; \
/*0x00AC*/ int		HScrollMax; \
/*0x00B0*/ COLORREF DisabledBackground; \
/*0x00B4*/ UINT		FadeDuration; \
/*0x00B8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00BC*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x00BD*/ bool		Faded; \
/*0x00C0*/ void *pController; \
/*0x00C4*/ UINT		BlinkFadeFreq; \
/*0x00C8*/ bool		bClientRectChanged; \
/*0x00C9*/ bool		bMaximizable; \
/*0x00CC*/ void   *TitlePiece2; \
/*0x00D0*/ RECT		OldLocation; \
/*0x00E0*/ BYTE     bResizableMask; \
/*0x00E1*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x00E2*/ bool		bFullyScreenClipped; \
/*0x00E4*/ tagSIZE	MaxClientSize; \
/*0x00EC*/ RECT		ClipRectClient; \
/*0x00FC*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x0100*/ int		DeleteCount; \
/*0x0104*/ bool		bTopAnchoredToTop; \
/*0x0108*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0120*/ bool		bBorder; \
/*0x0124*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0128*/ tagSIZE	MinClientSize; \
/*0x0130*/ int		RightOffset; \
/*0x0134*/ int		HScrollPos; \
/*0x0138*/ bool		bActive; \
/*0x0139*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x013A*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x013C*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0140*/ BYTE		StartAlpha; \
/*0x0141*/ bool		dShow; \
/*0x0142*/ bool		bKeepOnScreen; \
/*0x0143*/ bool		bScreenClipRectChanged; \
/*0x0144*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0145*/ bool		bCaptureTitle; \
/*0x0148*/ int		managerArrayIndex; \
/*0x014C*/ DWORD	LastTimeMouseOver; \
/*0x0150*/ void   *TitlePiece; \
/*0x0154*/ UINT		TransitionDuration; \
/*0x0158*/ int		BlinkState; \
/*0x015C*/ bool		Minimized; \
/*0x015D*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x015E*/ bool		bMarkedForDelete; \
/*0x0160*/ UINT		BlinkFadeDuration; \
/*0x0164*/ BYTE		FadeAlpha; \
/*0x0168*/ void*	pTextObject; \
/*0x016C*/ void		*pLayoutStrategy; \
/*0x0170*/ bool		bRightAnchoredToLeft; \
/*0x0174*/ int	Transition; \
/*0x0178*/ LONG		BlinkStartTimer; \
/*0x017C*/ RECT		IconRect; \
/*0x018C*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x018D*/ bool		bIsParentOrContextMenuWindow; \
/*0x018E*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x018F*/ bool		Enabled; \
/*0x0190*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x0194*/ RECT		ClientRect; \
/*0x01A8*/ __int64		Data; \
/*0x01B0*/ struct _CSIDLWND* pWndFocusOther; \
/*0x01B4*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x01B8*/ bool		Fades; \
/*0x01B9*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x01BC*/ UINT		TransitionStartTick; \
/*0x01C0*/ bool		bEscapableLocked; \
/*0x01C4*/ int		BottomOffset; \
/*0x01C8*/ bool		bAction; \
/*0x01C9*/ bool		bBringToTopWhenClicked; \
/*0x01CC*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x01D0*/ bool		bUseInLayoutVertical; \
/*0x01D4*/ int		TopOffset; \
/*0x01D8*/ void	    *pFont; \
/*0x01DC*/ DWORD  BackgroundDrawType; \
/*0x01E0*/ bool		bUseInLayoutHorizontal; \
/*0x01E1*/ BYTE Filler0x01E1[0x7]; \
/*0x01E8*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95f0 (see 56F8E2) in May 25 2021 Test - eqmule
...
// CPlayerWindow_size: 0x2e8 (see 56F220) in May 25 2021 Test - eqmule
...
// CTargetWindow_size: 0x8c8 (see 56F0C7) in May 25 2021 Test - eqmule
...
// CBuffWindow_size: 0x718 (see 56EF7B) in May 25 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x320 (see 84C5B7) in May 25 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2d0 (see 56F30D) in May 25 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2d0 (see 84C652) in May 25 2021 Test - eqmule
...
// CItemDisplayWindow_size: 0x630 (see 7A2B90) in May 25 2021 Test - eqmule
...
// CLootWnd_size: 0x398 (see 56F65A) in May 25 2021 Test - eqmule
...
// CMapViewWnd_size: 0x648 (see 56EDF0) in May 25 2021 Test - eqmule
...
// CMerchantWnd_size: 0x448 (see 56F7A6) in May 25 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8c8 (see 56E88B) in May 25 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a0 (see 56EB58) in May 25 2021 Test - eqmule
...
// CTradeWnd__size: 0x2f0 (see 56F844) in May 25 2021 Test - eqmule
...
// CFactionWnd__size: 0x278 (see 56F980) in May 25 2021 Test - eqmule
