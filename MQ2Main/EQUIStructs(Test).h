...
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x001D*/ bool		bFullyScreenClipped; \
/*0x001E*/ bool		Enabled; \
/*0x0020*/ int		HScrollMax; \
/*0x0024*/ bool		bRightAnchoredToLeft; \
/*0x0025*/ bool		bScreenClipRectChanged; \
/*0x0026*/ bool		bBorder2; \
...
/*0x0034*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0038*/ bool		bEscapableLocked; \
/*0x003C*/ COLORREF	BGColor; /* DO NOT CHNAGE THIS TO AN ARGBCOLOR, it will break the padding since its a union that has bytes in it. */ \
/*0x0040*/ bool		Minimized; \
/*0x0044*/ RECT		IconRect; \
/*0x0054*/ bool		bLeftAnchoredToLeft; \
/*0x0058*/ void	*DrawTemplate; \
/*0x005C*/ int		HScrollPos; \
...
/*0x0068*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x006C*/ RECT		ClipRectScreen; \
...
/*0x0084*/ bool		bUseInLayoutVertical; \
/*0x0085*/ bool		bClipToParent; \
/*0x0086*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0088*/ int		VScrollMax; \
/*0x008C*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0090*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0094*/ int	Transition; \
/*0x0098*/ RECT		TransitionRect; \
/*0x00A8*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x00AC*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x00C4*/ int		VScrollPos; \
/*0x00C8*/ bool		bBringToTopWhenClicked; \
/*0x00CC*/ RECT		ClientRect; \
/*0x00DC*/ DWORD  BackgroundDrawType; \
/*0x00E0*/ bool		bAction; \
/*0x00E4*/ void* pTipTextObject; \
/*0x00E8*/ DWORD	LastTimeMouseOver; \
/*0x00EC*/ bool		bTopAnchoredToTop; \
/*0x00F0*/ UINT		TransitionStartTick; \
/*0x00F4*/ UINT		BlinkFadeDuration; \
/*0x00F8*/ void*	pTextObject; \
/*0x00FC*/ struct _CSIDLWND* pWndFocusOther; \
/*0x0100*/ bool		dShow; \
/*0x0104*/ int		LeftOffset; \
/*0x0108*/ bool		bActive; \
...
/*0x011D*/ bool		bHCenterTooltip; \
/*0x011E*/ bool		Fades; \
/*0x0120*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x0124*/ UINT		BlinkFadeFreq; \
/*0x0128*/ bool		bMarkedForDelete; \
/*0x012C*/ UINT		FadeDuration; \
/*0x0130*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0134*/ BYTE     bResizableMask; \
/*0x0135*/ bool		bBottomAnchoredToTop; \
/*0x0136*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x0137*/ bool		bMaximized; \
/*0x0138*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x013C*/ int		BlinkState; \
/*0x0140*/ bool		bUseInLayoutHorizontal; \
/*0x0141*/ bool		bTiled; \
/*0x0144*/ int		BlinkDuration; \
/*0x0148*/ RECT		OldLocation; \
/*0x0158*/ int		RightOffset; \
/*0x015C*/ BYTE		StartAlpha; \
/*0x0160*/ tagSIZE	MaxClientSize; \
/*0x0168*/ bool		bKeepOnScreen; \
/*0x016C*/ tagSIZE	MinClientSize; \
/*0x0174*/ void	    *pFont; \
/*0x0178*/ void *pController; \
/*0x017C*/ BYTE		FadeAlpha; \
/*0x0180*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0184*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0188*/ bool		bIsParentOrContextMenuWindow; \
/*0x0189*/ bool		bClientClipRectChanged; \
/*0x018C*/ COLORREF DisabledBackground; \
/*0x0190*/ LONG		BlinkStartTimer; \
/*0x0194*/ BYTE		TargetAlpha; \
/*0x0198*/ int		TopOffset; \
/*0x019C*/ void	*IconTextureAnim; \
/*0x01A0*/ BYTE		Alpha; \
/*0x01A8*/ __int64		Data; \
/*0x01B0*/ UINT		TransitionDuration; \
/*0x01B4*/ bool		bIsTransitioning; \
/*0x01B5*/ bool		bClientRectChanged; \
/*0x01B6*/ bool		bBorder; \
/*0x01B8*/ void		*pLayoutStrategy; \
/*0x01BC*/ void   *TitlePiece; \
/*0x01C0*/ UINT		BlinkFadeStartTime; \
/*0x01C4*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01C5*/ bool		bMaximizable; \
/*0x01C8*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x01CC*/ RECT		Location; \
/*0x01DC*/ bool		bCaptureTitle; \
/*0x01E0*/ struct _CXSTR*	DataStr; \
/*0x01E4*/ int		DeleteCount; \
/*0x01E8*/ int		ParentAndContextMenuArrayIndex; \
/*0x01EC*/ DWORD	XMLIndex; \
/*0x01F0*/ DWORD	FadeDelay; \
...
// CBazaarSearchWnd_size: 0x9600 (see 56FD42) in Jun  8 2021 Test - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f8 (see 56F680) in Jun  8 2021 Test - eqmule
...
// CTargetWindow_size: 0x8d8 (see 56F527) in Jun  8 2021 Test - eqmule
...
// CBuffWindow_size: 0x728 (see 56F3DB) in Jun  8 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x330 (see 84CE8D) in Jun  8 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2e0 (see 56F76D) in Jun  8 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2e0 (see 84CF28) in Jun  8 2021 Test - eqmule
...
// CItemDisplayWindow_size: 0x640 (see 7A3450) in Jun  8 2021 Test - eqmule
...
// CLootWnd_size: 0x3a8 (see 56FABA) in Jun  8 2021 Test - eqmule
...
// CMapViewWnd_size: 0x668 (see 56F250) in Jun  8 2021 Test - eqmule
...
// CMerchantWnd_size: 0x458 (see 56FC06) in Jun  8 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8d8 (see 56ECEB) in Jun  8 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3b0 (see 56EFB8) in Jun  8 2021 Test - eqmule
...
// CTradeWnd__size: 0x300 (see 56FCA4) in Jun  8 2021 Test - eqmule
...
// CFactionWnd__size: 0x288 (see 56FDE0) in Jun  8 2021 Test - eqmule
