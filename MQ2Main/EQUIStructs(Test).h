...
// actual size 0x1F8 in Jun  8 2021 Test (see 0x9A034B) - eqmule
// actual size 0x1E0 in Jul 13 2021 Test (see 0x99F8DB) - eqmule
// actual size 0x1F0 in Jul 28 2021 Test (see 0x99FA3B) - eqmule
#define CXW_NO_VTABLE \
private: \
CXW_NO_VTABLE_BEGIN \
/*0x001C*/ bool		bBottomAnchoredToTop; \
/*0x0020*/ tagSIZE	MaxClientSize; \
/*0x0028*/ bool		Clickable;      /* found in CChatWindow__CChatWindow_x and the button handlers */ \
/*0x0029*/ bool		bMarkedForDelete; \
/*0x002A*/ bool		Fades; \
/*0x002B*/ bool		bBringToTopWhenClicked; \
...
/*0x0030*/ bool		bBorder; \
/*0x0031*/ bool		bScreenClipRectChanged; \
/*0x0034*/ DWORD	LastTimeMouseOver; \
/*0x0038*/ int		VScrollPos; \
/*0x003C*/ int		ZLayer; /* found in CXWndManager__DrawWindows_x */ \
/*0x0040*/ void	    *pFont; \
/*0x0044*/ UINT		TransitionStartTick; \
/*0x0048*/ ArrayClass2_RO<UINT> RuntimeTypes; /* Size 0x18 */ \
/*0x0060*/ void   *TitlePiece2; \
/*0x0064*/ tagSIZE	MinClientSize; \
/*0x006C*/ RECT		IconRect; \
/*0x007C*/ void*	pTextObject; \
/*0x0080*/ struct _CXSTR*	XMLToolTip; /* found in CSidlManager__CreateLabel_x */ \
/*0x0084*/ bool		bClipToParent; \
/*0x0088*/ struct _CXSTR*	DataStr; \
/*0x008C*/ int		TopOffset; \
/*0x0090*/ bool		bMaximized; \
/*0x0091*/ bool		bHCenterTooltip; \
/*0x0094*/ void		*pLayoutStrategy; \
/*0x0098*/ bool		Enabled; \
/*0x0099*/ bool		bKeepOnScreen; \
/*0x009C*/ struct _CSIDLWND* pWndFocusOther; \
/*0x00A0*/ bool		Locked; /* found in CSidlScreenWnd__LoadIniInfo_x */ \
/*0x00A4*/ UINT		FadeDuration; \
/*0x00A8*/ bool		bUseInLayoutVertical; \
/*0x00AC*/ struct _CXSTR*	Tooltip; /* found in CSidlManager__CreateLabel_x */ \
/*0x00B0*/ bool		bCaptureTitle; \
/*0x00B1*/ bool		bClientRectChanged; \
/*0x00B4*/ RECT		ClipRectClient; \
/*0x00C4*/ bool		MouseOver; /* found in CXWnd__SetMouseOver_x */ \
/*0x00C5*/ bool		bUseInLayoutHorizontal; \
/*0x00C6*/ bool		bMaximizable; \
/*0x00C7*/ BYTE		FadeAlpha; \
/*0x00C8*/ bool		bEscapableLocked; \
/*0x00CC*/ DWORD	FadeDelay; \
/*0x00D0*/ bool		dShow; \
/*0x00D1*/ BYTE		StartAlpha; \
/*0x00D2*/ bool		bRightAnchoredToLeft; \
/*0x00D4*/ void   *TitlePiece; \
/*0x00D8*/ bool		bBorder2; \
/*0x00D9*/ bool		bClientClipRectChanged; \
/*0x00DC*/ void *pController; \
/*0x00E0*/ BYTE     bResizableMask; \
/*0x00E1*/ bool		Faded; \
/*0x00E4*/ UINT		BlinkFadeStartTime; \
/*0x00E8*/ int		ParentAndContextMenuArrayIndex; \
/*0x00EC*/ int		LeftOffset; \
/*0x00F0*/ void* pTipTextObject; \
/*0x00F4*/ LONG		BlinkStartTimer; \
/*0x00F8*/ bool		bTiled; \
/*0x00FC*/ int	Transition; \
/*0x0100*/ RECT		TransitionRect; \
/*0x0110*/ int		VScrollMax; \
/*0x0114*/ COLORREF DisabledBackground; \
/*0x0118*/ bool		Minimized; \
/*0x0119*/ bool		bIsTransitioning; \
/*0x011C*/ void	*IconTextureAnim; \
/*0x0120*/ DWORD  BackgroundDrawType; \
/*0x0124*/ UINT		BlinkFadeDuration; \
/*0x0128*/ DWORD	BGType;         /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x012C*/ DWORD	WindowStyle;    /* bit 1 - vertical scroll, bit 2 - horizontal scroll, bit 4 - title bar?, bit 8 - border */ \
/*0x0130*/ int		HScrollMax; \
/*0x0134*/ bool		bAction; \
/*0x0135*/ bool		Unlockable;     /* found in CSidlScreenWnd__LoadIniInfo_x related to Locked */ \
/*0x0138*/ RECT		OldLocation; \
/*0x0148*/ bool		bIsParentOrContextMenuWindow; \
/*0x0150*/ __int64		Data; \
/*0x0158*/ RECT		ClientRect; \
/*0x0168*/ bool bShowClickThroughMenuItem;	/*shows/hides the click through option on the window menu*/ \
/*0x016C*/ int		managerArrayIndex; \
/*0x0170*/ UINT		TransitionDuration; \
/*0x0174*/ struct _CXSTR*	WindowText; /* CXWnd__GetWindowTextA_x has this one */ \
/*0x0178*/ int		BlinkDuration; \
/*0x017C*/ bool		bActive; \
/*0x0180*/ UINT		BlinkFadeFreq; \
/*0x0184*/ bool bClickThrough; /* if true you can click through the window, well it doesnt work for our chatwindow (yet) so more work is needed to figure out why */ \
/*0x0188*/ DWORD	XMLIndex; \
/*0x018C*/ UINT		LastBlinkFadeRefreshTime; \
/*0x0190*/ int		BottomOffset; \
/*0x0194*/ BYTE		FadeToAlpha; /* found in CSidlScreenWnd__StoreIniInfo_x */ \
/*0x0195*/ bool		bNeedsSaving; /* will be true if you move or resize the window */ \
/*0x0196*/ BYTE		TargetAlpha; \
/*0x0198*/ int		BlinkState; \
/*0x019C*/ int		HScrollPos; \
/*0x01A0*/ bool		bTopAnchoredToTop; \
/*0x01A1*/ bool		CloseOnESC;     /* found in CSidlScreenWnd__StoreIniInfo_x, close when ESC is pressed */ \
/*0x01A4*/ RECT		ClipRectScreen; \
/*0x01B4*/ COLORREF	CRNormal; /* found in OnProcessFrame */ \
/*0x01B8*/ bool		ValidCXWnd; /* IsValid has this one */ \
/*0x01BC*/ struct _CSIDLWND*		pParentWindow; /* CXWnd__IsDescendantOf_x has this one, If this is NULL, coordinates are absolute... */ \
/*0x01C0*/ bool		bFullyScreenClipped; \
/*0x01C4*/ void	*DrawTemplate; \
/*0x01C8*/ bool		bLeftAnchoredToLeft; \
/*0x01CC*/ int		RightOffset; \
/*0x01D0*/ BYTE		Alpha; \
/*0x01D4*/ RECT		Location; \
/*0x01E4*/ int		DeleteCount; \
/*0x01E8*/ bool bClickThroughMenuItemStatus; /* on/off */ \
/*0x01E9*/ BYTE Filler0x01E9[0x7]; \
/*0x01F0*/ \
public: \
			bool IsVisible() \
			{ \
...
// CBazaarSearchWnd_size: 0x95f8 (see 56FF02) in Jul 28 2021 Test - eqmule
...
//aAPwcsincombat
// CPlayerWindow_size: 0x2f0 (see 56F840) in Jul 28 2021 Test - eqmule
...
// CTargetWindow_size: 0x8d0 (see 56F6E7) in Jul 28 2021 Test - eqmule
...
// CBuffWindow_size: 0x720 (see 56F59B) in Jul 28 2021 Test - eqmule
...
// Individual Gems 
// CSpellGemWnd_size: 0x328 (see 84C673) in Jul 28 2021 Test - eqmule
...
// CCastSpellWnd_size: 0x2d8 (see 56F92D) in Jul 28 2021 Test - eqmule
...
// CInvSlotWnd_size: 0x2d8 (see 84C711) in Jul 28 2021 Test - eqmule
...
// CItemDisplayWindow_size: 0x638 (see 7A2C20) in Jul 28 2021 Test - eqmule
...
// CLootWnd_size: 0x3a0 (see 56FC7A) in Jul 28 2021 Test - eqmule
...
// CMapViewWnd_size: 0x658 (see 56F410) in Jul 28 2021 Test - eqmule
...
// CMerchantWnd_size: 0x448 (see 56FDC6) in Jul 28 2021 Test - eqmule
...
// CPetInfoWindow_size: 0x8d0 (see 56EEAB) in Jul 28 2021 Test - eqmule
...
//aClasscolorD
// CRaidWindow_size: 0x3a8 (see 56F178) in Jul 28 2021 Test - eqmule
...
// CTradeWnd__size: 0x2f8 (see 56FE64) in Jul 28 2021 Test - eqmule
...
// CFactionWnd__size: 0x280 (see 56FFA0) in Jul 28 2021 Test - eqmule
